...
interface OutlawRunProps {
  onBack: () => void;
}

export default function OutlawRun({ onBack }: OutlawRunProps) { //onBack aggiunto per rendere possibile l'accesso da Menu Principale plus pulsante per tornare indietro e cambiare gioco
