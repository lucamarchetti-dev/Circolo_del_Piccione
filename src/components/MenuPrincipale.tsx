...
// Assets – Vite import
// farwest_road.jpeg mancante → uso l'immagine jpg disponibile in assets/png
const farwestRoad = "/images/country1.jpg";
<img src={farwestRoad} alt="" />
import sfondoCielo from '../assets/png/sfondo-cielo.png';
// piccione-volante-2 è in assets/png, non in assets/
import piccione from '../assets/png/piccione-volante-2.png';
import pigeonLogo from '../assets/Pigeon.png';
// sfondo2.jpg mancante → usa sfondo-cielo come fallback (sostituibile quando hai il file)
const menuBg = "/images/legna.jpg";
