...
var arrayProduct, MatMulProgramType;
...
var atomicAddSnippet;
var init_shader_util = __esm({
  "node_modules/@tensorflow/tfjs-backend-webgpu/dist/shader_util.js"() {
    atomicAddSnippet = (ptr, v, type) => {
      if (type === "int32") {
...
var PixelsOpType, compileProgram, typeSnippet, commonSnippet, isInfSnippet;
var init_webgpu_program = __esm({
  "node_modules/@tensorflow/tfjs-backend-webgpu/dist/webgpu_program.js"() {
    ...
    compileProgram = (device, program, inputsData, output, parallelCompilation) => {
    ...
    typeSnippet = (component, type = "f32") => {
      switch (component) {
        case 1:
          return `${type}`;
        case 2:
...
var CPU_HANDOFF_SIZE_THRESHOLD, reshapeDispatch, WebGPUBackend;
var init_backend_webgpu = __esm({
  "node_modules/@tensorflow/tfjs-backend-webgpu/dist/backend_webgpu.js"() {
    ...
    init_webgpu_program();
    init_webgpu_util();
    CPU_HANDOFF_SIZE_THRESHOLD = env().getNumber("WEBGPU_CPU_HANDOFF_SIZE_THRESHOLD");
    reshapeDispatch = (device, program) => {
    ...
    WebGPUBackend = class _WebGPUBackend extends KernelBackend {
      nextDataId() {
...
var BinaryOpType, ADD, ATAN2, COMPLEX_MULTIPLY_REAL, COMPLEX_MULTIPLY_IMAG, DIV, ELU_DER, EQUAL, FLOOR_DIV, GREATER, GREATER_EQUAL, LESS, LESS_EQUAL, LOGICAL_AND, LOGICAL_AND_VEC4, LOGICAL_OR, LOGICAL_OR_VEC4, MAX, MIN, MOD, MOD_VEC4, MUL, NOT_EQUAL, NOT_EQUAL_VEC4, POW, POW_VEC4, PRELU, PRELU_VEC4, SQUARED_DIFFERENCE, SUB;
var init_binary_op_util = __esm({
  "node_modules/@tensorflow/tfjs-backend-webgpu/dist/binary_op_util.js"() {
    ...
    ADD = "let resultTemp = a + b;";
    ATAN2 = "let resultTemp = atan2(a, b);";
    COMPLEX_MULTIPLY_REAL = "let resultTemp = areal * breal - aimag * bimag;";
    COMPLEX_MULTIPLY_IMAG = "let resultTemp = areal * bimag + aimag * breal;";
    DIV = "let resultTemp = a / b;";
    ELU_DER = "let resultTemp = select(a * (b + 1.0), a, b >= b - b);";
    EQUAL = `
  let zero = sign(a) * 0 + 0;
  let one = sign(b) * 0 + 1;
...
`;
  ...
  let resultTemp = select(zero, one, a <= b);
`;
    LOGICAL_AND = "return f32(a >= 1.0 && b >= 1.0);";
    LOGICAL_AND_VEC4 = `return (vec4<f32>(a >= vec4<f32>(1.0)) *
  vec4<f32>(b >= vec4<f32>(1.0)));`;
    LOGICAL_OR = "return f32(a >= 1.0 || b >= 1.0);";
    LOGICAL_OR_VEC4 = `return min(vec4<f32>(a >= vec4<f32>(1.0)) +
  vec4<f32>(b >= vec4<f32>(1.0)), vec4<f32>(1.0));`;
    MAX = "let resultTemp = max(a, b);";
    MIN = "let resultTemp = min(a, b);";
    MOD = `
  let isNaN = b == 0.;
  var resultTemp = a % b;
...
`;
    PRELU = `if (a < 0.0) { return b * a; }  return a;`;
    PRELU_VEC4 = `
  let aLessThanZero = vec4<f32>(a < vec4<f32>(0.0));
  return (aLessThanZero * (b * a)) + ((vec4<f32>(1.0) - aLessThanZero) * a);
`;
    SQUARED_DIFFERENCE = "let resultTemp = (a - b) * (a - b);";
    SUB = "let resultTemp = a - b;";
  }
});
...
var UnaryOpType, ABS, ACOS, ACOSH, ASIN, ASINH, ATAN, ATANH, CEIL, COS, COSH, EXPM1, ELU, ELU_VEC4, ERF, EXP, FLOOR, IS_FINITE, IS_INF, IS_NAN, LINEAR, LOG, LOG1P, LOGICAL_NOT, NEG, LEAKYRELU, LEAKYRELU_VEC4, RECIPROCAL, RELU, RELU6, RELU6_VEC4, RELU_VEC4, ROUND, RSQRT, SELU, SIGMOID, SIGN, SIN, SINH, SOFTPLUS, SQRT, SQUARE, STEP, TAN, TANH, TO_INT;
...
`;
    EXPM1 = `return exp(a) - 1.0;`;
    ELU = `if (a >= 0.0) { return a; }  return (exp(a) - 1.0);`;
    ELU_VEC4 = `
...
`;
    ...
    IS_FINITE = `return f32(!isnan(a) && !isinf(a));`;
    IS_INF = `return f32(isinf(a));`;
    IS_NAN = `return f32(isnan(a));`;
    LINEAR = `return a;`;
    LOG = `if (a < 0.0) { return uniforms.NAN; }
  return log(a);`;
    LOG1P = `
  if (isnan(a)) { return a; }
  return log(1.0 + a);
`;
    LOGICAL_NOT = `return f32(!(a >= 1.0));`;
    NEG = `return -a;`;
    LEAKYRELU = `if (a < 0.0) { return uniforms.alpha * a; } return a;`;
    LEAKYRELU_VEC4 = `
  let aLessThanZero = vec4<f32>(a < vec4<f32>(0.0));
  return (aLessThanZero * (uniforms.alpha * a)) + ((vec4<f32>(1.0) - aLessThanZero) * a);
`;
    RECIPROCAL = `return 1.0 / a;`;
    RELU = `return select(a, 0.0, a < 0.0);`;
    RELU6 = "return clamp(a, 0.0, 6.0);";
    RELU6_VEC4 = "return clamp(a, vec4<f32>(0.0, 0.0, 0.0, 0.0), vec4<f32>(6.0, 6.0, 6.0, 6.0));";
    RELU_VEC4 = `
  return select(a, vec4<f32>(0.0), a < vec4<f32>(0.0));
`;
    ROUND = `return round(a);`;
    RSQRT = `return inverseSqrt(a);`;
    SELU = `
  if (a >= 0.0) {
...
`;
    SIGMOID = `return 1.0 / (1.0 + exp(-1.0 * a));`;
    SIGN = `return sign(a);`;
    SIN = `return sin(a);`;
    SINH = `
  let e2x = exp(a);
...
var writeDataToSubAVec4Snippet, calculateResultSnippet, writeDataToSubASnippet, readDataFromSubASnippet, readVectorASnippet, MatMulPackedProgram;
var init_matmul_packed_webgpu = __esm({
  "node_modules/@tensorflow/tfjs-backend-webgpu/dist/matmul_packed_webgpu.js"() {
    ...
    init_webgpu_program();
    init_webgpu_util();
    writeDataToSubAVec4Snippet = (transpose2, innerElementSize) => {
      if (transpose2) {
        return `
    ...
    writeDataToSubASnippet = (transpose2) => {
      if (transpose2) {
        return `
        mm_Asub[inputRow][inputCol] = mm_readA(batchA,
          kStart + inputRow,
...
var MatMulSmallOutputSizeProgram;
var init_matmul_small_output_size_webgpu = __esm({
  "node_modules/@tensorflow/tfjs-backend-webgpu/dist/matmul_small_output_size_webgpu.js"() {
    init_activation_util();
    init_matmul_packed_webgpu();
    init_webgpu_program();
    MatMulSmallOutputSizeProgram = class {
...
var MatMulSplitKProgram, BiasActivationProgram;
...
var init_Abs = __esm({
  "node_modules/@tensorflow/tfjs-backend-webgpu/dist/kernels/Abs.js"() {
    ...
    init_shared2();
    init_unary_op_util();
    abs = unaryKernelFunc({ opType: UnaryOpType.ABS, cpuKernelImpl: simpleAbsImplCPU });
    absConfig = {
      kernelName: Abs,
      backendName: "webgpu",
      kernelFunc: abs
...
var init_Acos = __esm({
  "node_modules/@tensorflow/tfjs-backend-webgpu/dist/kernels/Acos.js"() {
    ...
    init_kernel_funcs_utils();
    init_unary_op_util();
    acos = unaryKernelFunc({ opType: UnaryOpType.ACOS });
    acosConfig = {
      kernelName: Acos,
      backendName: "webgpu",
      kernelFunc: acos
...
var acosh, acoshConfig;
var init_Acosh = __esm({
  "node_modules/@tensorflow/tfjs-backend-webgpu/dist/kernels/Acosh.js"() {
    init_dist();
    init_kernel_funcs_utils();
    init_unary_op_util();
    acosh = unaryKernelFunc({ opType: UnaryOpType.ACOSH });
    acoshConfig = {
      kernelName: Acosh,
      backendName: "webgpu",
      kernelFunc: acosh
...
var init_Add = __esm({
  "node_modules/@tensorflow/tfjs-backend-webgpu/dist/kernels/Add.js"() {
    ...
    init_kernel_funcs_utils();
    init_shared2();
    addKernelFunc = binaryKernelFunc({ opType: BinaryOpType.ADD, cpuKernelImpl: addImplCPU, supportsComplex: true });
    addConfig = {
      kernelName: Add,
      backendName: "webgpu",
...
var TransposeSharedProgram;
var init_transpose_shared_webgpu = __esm({
  "node_modules/@tensorflow/tfjs-backend-webgpu/dist/transpose_shared_webgpu.js"() {
    init_dist();
    init_webgpu_program();
    init_webgpu_util();
    TransposeSharedProgram = class {
...
var init_Asin = __esm({
  "node_modules/@tensorflow/tfjs-backend-webgpu/dist/kernels/Asin.js"() {
    ...
    init_kernel_funcs_utils();
    init_unary_op_util();
    asin = unaryKernelFunc({ opType: UnaryOpType.ASIN });
    asinConfig = {
      kernelName: Asin,
      backendName: "webgpu",
      kernelFunc: asin
...
var asinh, asinhConfig;
var init_Asinh = __esm({
  "node_modules/@tensorflow/tfjs-backend-webgpu/dist/kernels/Asinh.js"() {
    init_dist();
    init_kernel_funcs_utils();
    init_unary_op_util();
    asinh = unaryKernelFunc({ opType: UnaryOpType.ASINH });
    asinhConfig = {
      kernelName: Asinh,
      backendName: "webgpu",
      kernelFunc: asinh
...
var init_Atan = __esm({
  "node_modules/@tensorflow/tfjs-backend-webgpu/dist/kernels/Atan.js"() {
    ...
    init_kernel_funcs_utils();
    init_unary_op_util();
    atan = unaryKernelFunc({ opType: UnaryOpType.ATAN });
    atanConfig = {
      kernelName: Atan,
      backendName: "webgpu",
      kernelFunc: atan
...
var atan2, atan2Config;
var init_Atan2 = __esm({
  "node_modules/@tensorflow/tfjs-backend-webgpu/dist/kernels/Atan2.js"() {
    init_dist();
    init_binary_op_util();
    init_kernel_funcs_utils();
    atan2 = binaryKernelFunc({ opType: BinaryOpType.ATAN2 });
    atan2Config = {
      kernelName: Atan2,
      backendName: "webgpu",
      kernelFunc: atan2
...
var atanh, atanhConfig;
var init_Atanh = __esm({
  "node_modules/@tensorflow/tfjs-backend-webgpu/dist/kernels/Atanh.js"() {
    init_dist();
    init_kernel_funcs_utils();
    init_unary_op_util();
    atanh = unaryKernelFunc({ opType: UnaryOpType.ATANH });
    atanhConfig = {
      kernelName: Atanh,
      backendName: "webgpu",
      kernelFunc: atanh
...
var PoolWithFilterSizeEqualsOneProgram;
var init_pool_filtersizeone_webgpu = __esm({
  "node_modules/@tensorflow/tfjs-backend-webgpu/dist/pool_filtersizeone_webgpu.js"() {
    init_webgpu_program();
    init_webgpu_util();
    PoolWithFilterSizeEqualsOneProgram = class {
...
var Pool2DProgram, Pool3DProgram;
...
var AvgPool2DBackpropProgram, AvgPool3DBackpropProgram;
...
var batchToSpaceND, batchToSpaceNDConfig;
...
var writeSnippet, binaryWriteSnippet, BincountProgram;
...
var BroadcastArgsProgram;
var init_broadcast_args_webgpu = __esm({
  "node_modules/@tensorflow/tfjs-backend-webgpu/dist/broadcast_args_webgpu.js"() {
    init_webgpu_program();
    init_webgpu_util();
    BroadcastArgsProgram = class {
      constructor(shape) {
        this.outputShape = [];
...
var init_Ceil = __esm({
  "node_modules/@tensorflow/tfjs-backend-webgpu/dist/kernels/Ceil.js"() {
    ...
    init_shared2();
    init_unary_op_util();
    ceil = unaryKernelFunc({ opType: UnaryOpType.CEIL, cpuKernelImpl: ceilImplCPU });
    ceilConfig = {
      kernelName: Ceil,
      backendName: "webgpu",
      kernelFunc: ceil
...
var Conv2DNaiveProgram;
var init_conv2d_naive_webgpu = __esm({
  "node_modules/@tensorflow/tfjs-backend-webgpu/dist/conv2d_naive_webgpu.js"() {
    init_activation_util();
    init_webgpu_program();
    init_webgpu_util();
    Conv2DNaiveProgram = class {
...
var Conv2DDerInputProgram, Conv2DDerFilterProgram, Conv3DDerFilterProgram, Conv3DDerInputProgram;
...
var Conv3DNaiveProgram;
var init_conv3d_naive_webgpu = __esm({
  "node_modules/@tensorflow/tfjs-backend-webgpu/dist/conv3d_naive_webgpu.js"() {
    init_webgpu_program();
    init_webgpu_util();
    Conv3DNaiveProgram = class {
      constructor(convInfo) {
        this.variableNames = ["x", "W"];
...
var init_Cos = __esm({
  "node_modules/@tensorflow/tfjs-backend-webgpu/dist/kernels/Cos.js"() {
    ...
    init_kernel_funcs_utils();
    init_unary_op_util();
    cos = unaryKernelFunc({ opType: UnaryOpType.COS });
    cosConfig = {
      kernelName: Cos,
      backendName: "webgpu",
      kernelFunc: cos
...
var init_Cosh = __esm({
  "node_modules/@tensorflow/tfjs-backend-webgpu/dist/kernels/Cosh.js"() {
    ...
    init_kernel_funcs_utils();
    init_unary_op_util();
    cosh = unaryKernelFunc({ opType: UnaryOpType.COSH });
    coshConfig = {
      kernelName: Cosh,
      backendName: "webgpu",
      kernelFunc: cosh
...
var cropAndResize, cropAndResizeConfig;
...
var DepthwiseConv2DNCHWSharedProgram;
var init_depthwise_conv2d_nchw_shared_webgpu = __esm({
  "node_modules/@tensorflow/tfjs-backend-webgpu/dist/depthwise_conv2d_nchw_shared_webgpu.js"() {
    init_activation_util();
    init_webgpu_program();
    init_webgpu_util();
    DepthwiseConv2DNCHWSharedProgram = class {
...
var DepthwiseConv2DVec4Program;
var init_depthwise_conv2d_vec4_webgpu = __esm({
  "node_modules/@tensorflow/tfjs-backend-webgpu/dist/depthwise_conv2d_vec4_webgpu.js"() {
    ...
    init_webgpu_program();
    init_webgpu_util();
    DepthwiseConv2DVec4Program = class {
...
var DepthwiseConv2DDerFilterProgram, DepthwiseConv2DDerInputProgram;
...
var Dilation2DBackpropInputProgram, Dilation2DBackpropFilterProgram;
var init_dilation_backprop_webgpu = __esm({
  "node_modules/@tensorflow/tfjs-backend-webgpu/dist/dilation_backprop_webgpu.js"() {
    init_shader_util();
    init_webgpu_program();
    init_webgpu_util();
    Dilation2DBackpropInputProgram = class {
    ...
    Dilation2DBackpropFilterProgram = class {
...
var multiplyKernelFunc, multiplyConfig;
var init_Multiply = __esm({
  "node_modules/@tensorflow/tfjs-backend-webgpu/dist/kernels/Multiply.js"() {
    ...
    init_kernel_funcs_utils();
    init_shared2();
    multiplyKernelFunc = binaryKernelFunc({
...
var init_Elu = __esm({
  "node_modules/@tensorflow/tfjs-backend-webgpu/dist/kernels/Elu.js"() {
    ...
    init_kernel_funcs_utils();
    init_unary_op_util();
    elu = unaryKernelFunc({ opType: UnaryOpType.ELU });
    eluConfig = {
      kernelName: Elu,
      backendName: "webgpu",
      kernelFunc: elu
...
var init_Equal = __esm({
  "node_modules/@tensorflow/tfjs-backend-webgpu/dist/kernels/Equal.js"() {
    ...
    init_kernel_funcs_utils();
    init_shared2();
    equal = binaryKernelFunc({ opType: BinaryOpType.EQUAL, dtype: "bool", cpuKernelImpl: equalImplCPU });
    equalConfig = {
      kernelName: Equal,
      backendName: "webgpu",
      kernelFunc: equal
...
var init_Erf = __esm({
  "node_modules/@tensorflow/tfjs-backend-webgpu/dist/kernels/Erf.js"() {
    ...
    init_kernel_funcs_utils();
    init_unary_op_util();
    erf = unaryKernelFunc({ opType: UnaryOpType.ERF });
    erfConfig = {
      kernelName: Erf,
      backendName: "webgpu",
      kernelFunc: erf
...
var init_Expm1 = __esm({
  "node_modules/@tensorflow/tfjs-backend-webgpu/dist/kernels/Expm1.js"() {
    ...
    init_shared2();
    init_unary_op_util();
    expm1 = unaryKernelFunc({ opType: UnaryOpType.EXPM1, cpuKernelImpl: expm1ImplCPU });
    expm1Config = {
      kernelName: Expm1,
      backendName: "webgpu",
      kernelFunc: expm1
...
var init_Floor = __esm({
  "node_modules/@tensorflow/tfjs-backend-webgpu/dist/kernels/Floor.js"() {
    ...
    init_shared2();
    init_unary_op_util();
    floor = unaryKernelFunc({ opType: UnaryOpType.FLOOR, cpuKernelImpl: floorImplCPU });
    floorConfig = {
      kernelName: Floor,
      backendName: "webgpu",
      kernelFunc: floor
...
var greaterEqual, greaterEqualConfig;
...
var isFinite, isFiniteConfig;
var init_IsFinite = __esm({
  "node_modules/@tensorflow/tfjs-backend-webgpu/dist/kernels/IsFinite.js"() {
    init_dist();
    init_kernel_funcs_utils();
    init_unary_op_util();
    isFinite = unaryKernelFunc({ opType: UnaryOpType.IS_FINITE, dtype: "bool" });
    isFiniteConfig = {
      kernelName: IsFinite,
      backendName: "webgpu",
      kernelFunc: isFinite
...
var isInf, isInfConfig;
var init_IsInf = __esm({
  "node_modules/@tensorflow/tfjs-backend-webgpu/dist/kernels/IsInf.js"() {
    init_dist();
    init_kernel_funcs_utils();
    init_unary_op_util();
    isInf = unaryKernelFunc({ opType: UnaryOpType.IS_INF, dtype: "bool" });
    isInfConfig = {
      kernelName: IsInf,
      backendName: "webgpu",
      kernelFunc: isInf
...
var isNaN, isNaNConfig;
var init_IsNaN = __esm({
  "node_modules/@tensorflow/tfjs-backend-webgpu/dist/kernels/IsNaN.js"() {
    init_dist();
    init_kernel_funcs_utils();
    init_unary_op_util();
    isNaN = unaryKernelFunc({ opType: UnaryOpType.IS_NAN, dtype: "bool" });
    isNaNConfig = {
      kernelName: IsNan,
      backendName: "webgpu",
      kernelFunc: isNaN
...
var init_Less = __esm({
  "node_modules/@tensorflow/tfjs-backend-webgpu/dist/kernels/Less.js"() {
    ...
    init_kernel_funcs_utils();
    init_shared2();
    less = binaryKernelFunc({ opType: BinaryOpType.LESS, dtype: "bool", cpuKernelImpl: lessImplCPU });
    lessConfig = {
      kernelName: Less,
      backendName: "webgpu",
      kernelFunc: less
...
var init_Log = __esm({
  "node_modules/@tensorflow/tfjs-backend-webgpu/dist/kernels/Log.js"() {
    ...
    init_shared2();
    init_unary_op_util();
    log = unaryKernelFunc({ opType: UnaryOpType.LOG, cpuKernelImpl: logImplCPU });
    logConfig = {
      kernelName: Log,
      backendName: "webgpu",
      kernelFunc: log
...
var log1p, log1pConfig;
var init_Log1p = __esm({
  "node_modules/@tensorflow/tfjs-backend-webgpu/dist/kernels/Log1p.js"() {
    init_dist();
    init_kernel_funcs_utils();
    init_unary_op_util();
    log1p = unaryKernelFunc({ opType: UnaryOpType.LOG1P });
    log1pConfig = {
      kernelName: Log1p,
      backendName: "webgpu",
      kernelFunc: log1p
...
var logicalAnd, logicalAndConfig;
var init_LogicalAnd = __esm({
  "node_modules/@tensorflow/tfjs-backend-webgpu/dist/kernels/LogicalAnd.js"() {
    init_dist();
    init_binary_op_util();
    init_kernel_funcs_utils();
    logicalAnd = binaryKernelFunc({ opType: BinaryOpType.LOGICAL_AND, dtype: "bool" });
    logicalAndConfig = {
...
var logicalNot, logicalNotConfig;
var init_LogicalNot = __esm({
  "node_modules/@tensorflow/tfjs-backend-webgpu/dist/kernels/LogicalNot.js"() {
    init_dist();
    init_kernel_funcs_utils();
    init_unary_op_util();
    logicalNot = unaryKernelFunc({ opType: UnaryOpType.LOGICAL_NOT });
    logicalNotConfig = {
...
var logicalOr, logicalOrConfig;
var init_LogicalOr = __esm({
  "node_modules/@tensorflow/tfjs-backend-webgpu/dist/kernels/LogicalOr.js"() {
    init_dist();
    init_binary_op_util();
    init_kernel_funcs_utils();
    logicalOr = binaryKernelFunc({ opType: BinaryOpType.LOGICAL_OR });
    logicalOrConfig = {
...
var powOperatorSnippet, LRNProgram, LRNSharedProgram;
...
var MaxPool2DBackpropProgram, MaxPool3DBackpropProgram;
...
var init_Mod = __esm({
  "node_modules/@tensorflow/tfjs-backend-webgpu/dist/kernels/Mod.js"() {
    ...
    init_binary_op_util();
    init_kernel_funcs_utils();
    mod = binaryKernelFunc({ opType: BinaryOpType.MOD });
    modConfig = {
      kernelName: Mod,
      backendName: "webgpu",
      kernelFunc: mod
...
var realDiv, realDivConfig;
var init_RealDiv = __esm({
  "node_modules/@tensorflow/tfjs-backend-webgpu/dist/kernels/RealDiv.js"() {
    init_dist();
    init_binary_op_util();
    init_kernel_funcs_utils();
    realDiv = binaryKernelFunc({ opType: BinaryOpType.DIV });
    realDivConfig = {
      kernelName: RealDiv,
      backendName: "webgpu",
      kernelFunc: realDiv
...
var reciprocal, reciprocalConfig;
var init_Reciprocal = __esm({
  "node_modules/@tensorflow/tfjs-backend-webgpu/dist/kernels/Reciprocal.js"() {
    init_dist();
    init_kernel_funcs_utils();
    init_unary_op_util();
    reciprocal = unaryKernelFunc({ opType: UnaryOpType.RECIPROCAL });
    reciprocalConfig = {
...
var init_Relu = __esm({
  "node_modules/@tensorflow/tfjs-backend-webgpu/dist/kernels/Relu.js"() {
    ...
    init_kernel_funcs_utils();
    init_unary_op_util();
    relu = unaryKernelFunc({ opType: UnaryOpType.RELU });
    reluConfig = {
      kernelName: Relu,
      backendName: "webgpu",
      kernelFunc: relu
...
var relu6, relu6Config;
var init_Relu6 = __esm({
  "node_modules/@tensorflow/tfjs-backend-webgpu/dist/kernels/Relu6.js"() {
    init_dist();
    init_kernel_funcs_utils();
    init_unary_op_util();
    relu6 = unaryKernelFunc({ opType: UnaryOpType.RELU6 });
    relu6Config = {
      kernelName: Relu6,
      backendName: "webgpu",
      kernelFunc: relu6
...
var round, roundConfig;
var init_Round = __esm({
  "node_modules/@tensorflow/tfjs-backend-webgpu/dist/kernels/Round.js"() {
    init_dist();
    init_kernel_funcs_utils();
    init_unary_op_util();
    round = unaryKernelFunc({ opType: UnaryOpType.ROUND });
    roundConfig = {
      kernelName: Round,
      backendName: "webgpu",
      kernelFunc: round
...
var init_Rsqrt = __esm({
  "node_modules/@tensorflow/tfjs-backend-webgpu/dist/kernels/Rsqrt.js"() {
    ...
    init_shared2();
    init_unary_op_util();
    rsqrt = unaryKernelFunc({ opType: UnaryOpType.RSQRT, cpuKernelImpl: rsqrtImplCPU });
    rsqrtConfig = {
      kernelName: Rsqrt,
      backendName: "webgpu",
      kernelFunc: rsqrt
...
var init_Selu = __esm({
  "node_modules/@tensorflow/tfjs-backend-webgpu/dist/kernels/Selu.js"() {
    ...
    init_kernel_funcs_utils();
    init_unary_op_util();
    selu = unaryKernelFunc({ opType: UnaryOpType.SELU });
    seluConfig = {
      kernelName: Selu,
      backendName: "webgpu",
      kernelFunc: selu
...
var sigmoid, sigmoidConfig;
var init_Sigmoid = __esm({
  "node_modules/@tensorflow/tfjs-backend-webgpu/dist/kernels/Sigmoid.js"() {
    init_dist();
    init_kernel_funcs_utils();
    init_unary_op_util();
    sigmoid = unaryKernelFunc({ opType: UnaryOpType.SIGMOID });
    sigmoidConfig = {
      kernelName: Sigmoid,
      backendName: "webgpu",
      kernelFunc: sigmoid
...
var init_Sign = __esm({
  "node_modules/@tensorflow/tfjs-backend-webgpu/dist/kernels/Sign.js"() {
    ...
    init_kernel_funcs_utils();
    init_unary_op_util();
    sign = unaryKernelFunc({ opType: UnaryOpType.SIGN });
    signConfig = {
      kernelName: Sign,
      backendName: "webgpu",
      kernelFunc: sign
...
var init_Sin = __esm({
  "node_modules/@tensorflow/tfjs-backend-webgpu/dist/kernels/Sin.js"() {
    ...
    init_kernel_funcs_utils();
    init_unary_op_util();
    sin = unaryKernelFunc({ opType: UnaryOpType.SIN });
    sinConfig = {
      kernelName: Sin,
      backendName: "webgpu",
      kernelFunc: sin
...
var init_Sinh = __esm({
  "node_modules/@tensorflow/tfjs-backend-webgpu/dist/kernels/Sinh.js"() {
    ...
    init_kernel_funcs_utils();
    init_unary_op_util();
    sinh = unaryKernelFunc({ opType: UnaryOpType.SINH });
    sinhConfig = {
      kernelName: Sinh,
      backendName: "webgpu",
      kernelFunc: sinh
...
var softplus, softplusConfig;
var init_Softplus = __esm({
  "node_modules/@tensorflow/tfjs-backend-webgpu/dist/kernels/Softplus.js"() {
    init_dist();
    init_kernel_funcs_utils();
    init_unary_op_util();
    softplus = unaryKernelFunc({ opType: UnaryOpType.SOFTPLUS });
    softplusConfig = {
      kernelName: Softplus,
      backendName: "webgpu",
      kernelFunc: softplus
...
var spaceToBatchND, spaceToBatchNDConfig;
...
var SparseSegmentSumProgram, SparseSegmentIdCountProgram, SparseSegmentMeanProgram;
var init_sparse_segment_reduce_webgpu = __esm({
  "node_modules/@tensorflow/tfjs-backend-webgpu/dist/sparse_segment_reduce_webgpu.js"() {
    init_shader_util();
    init_webgpu_program();
    init_webgpu_util();
    SparseSegmentSumProgram = class {
  ...
  `;
    ...
    SparseSegmentIdCountProgram = class {
  ...
  `;
    ...
    SparseSegmentMeanProgram = class {
...
var init_Sqrt = __esm({
  "node_modules/@tensorflow/tfjs-backend-webgpu/dist/kernels/Sqrt.js"() {
    ...
    init_kernel_funcs_utils();
    init_unary_op_util();
    sqrt = unaryKernelFunc({ opType: UnaryOpType.SQRT });
    sqrtConfig = {
      kernelName: Sqrt,
      backendName: "webgpu",
      kernelFunc: sqrt
...
var squaredDifference, squaredDifferenceConfig;
...
var init_Sub = __esm({
  "node_modules/@tensorflow/tfjs-backend-webgpu/dist/kernels/Sub.js"() {
    ...
    init_kernel_funcs_utils();
    init_shared2();
    sub = binaryKernelFunc({ opType: BinaryOpType.SUB, cpuKernelImpl: subImplCPU, supportsComplex: true });
    subConfig = {
      kernelName: Sub,
      backendName: "webgpu",
      kernelFunc: sub
...
var init_Tan = __esm({
  "node_modules/@tensorflow/tfjs-backend-webgpu/dist/kernels/Tan.js"() {
    ...
    init_kernel_funcs_utils();
    init_unary_op_util();
    tan = unaryKernelFunc({ opType: UnaryOpType.TAN });
    tanConfig = {
      kernelName: Tan,
      backendName: "webgpu",
      kernelFunc: tan
...
var init_Tanh = __esm({
  "node_modules/@tensorflow/tfjs-backend-webgpu/dist/kernels/Tanh.js"() {
    ...
    init_kernel_funcs_utils();
    init_unary_op_util();
    tanh = unaryKernelFunc({ opType: UnaryOpType.TANH });
    tanhConfig = {
      kernelName: Tanh,
      backendName: "webgpu",
      kernelFunc: tanh
...
var UnsortedSegmentSumProgram;
var init_unsorted_segment_sum_webgpu = __esm({
  "node_modules/@tensorflow/tfjs-backend-webgpu/dist/unsorted_segment_sum_webgpu.js"() {
    init_shader_util();
    init_webgpu_program();
    init_webgpu_util();
    UnsortedSegmentSumProgram = class {
...
@tensorflow/tfjs-backend-webgpu/dist/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-FDLFP23L.js.map
