...
} from "./chunk-FDLFP23L.js";
import {
  dist_exports,
  dist_exports2,
  init_dist,
  init_dist2
} from "./chunk-GBLCKU3P.js";
import {
  __commonJS,
  __toCommonJS
} from "./chunk-V4OQ3NZ2.js";

// vite:cjs-external-facade:@mediapipe/pose
import * as m from "@mediapipe/pose";
var require_pose = __commonJS({
  "vite:cjs-external-facade:@mediapipe/pose"(exports, module) {
    module.exports = m;
  }
});

// node_modules/@tensorflow-models/pose-detection/dist/constants.js
var require_constants = __commonJS({
  "node_modules/@tensorflow-models/pose-detection/dist/constants.js"(exports) {
    "use strict";
...
// node_modules/@tensorflow-models/pose-detection/dist/shared/calculators/mask_util.js
var require_mask_util = __commonJS({
  "node_modules/@tensorflow-models/pose-detection/dist/shared/calculators/mask_util.js"(exports) {
    "use strict";
        ...
        return __generator(this, function(_a) {
          switch (_a.label) {
            case 0:
              ...
              if (!(image instanceof tf.Tensor)) return [3, 2];
              return [4, tf.browser.toPixels(image, canvas)];
            case 1:
              _a.sent();
              return [3, 3];
            case 2:
        ...
        return __generator(this, function(_c) {
          switch (_c.label) {
            case 0:
              ...
              _b = ImageData.bind;
              return [4, tf.browser.toPixels(image)];
            case 1:
              return [2, new (_b.apply(ImageData, [void 0, _c.sent(), width, height]))()];
            case 2:
              canvas = document.createElement("canvas");
              ctx = canvas.getContext("2d");
              canvas.width = toNumber(image.width);
              canvas.height = toNumber(image.height);
              ctx.drawImage(image, 0, 0);
              return [2, ctx.getImageData(0, 0, canvas.width, canvas.height)];
          }
        });
      });
    }
    ...
    function toTensorLossy(image) {
      return __awaiter(this, void 0, void 0, function() {
        ...
        return __generator(this, function(_b) {
          switch (_b.label) {
            case 0:
              if (!(image instanceof SVGImageElement || image instanceof OffscreenCanvas)) return [3, 2];
              return [4, toHTMLCanvasElementLossy(image)];
            case 1:
              _a = _b.sent();
              return [3, 3];
            case 2:
            ...
            case 3:
              pixelsInput = _a;
              return [2, tf.browser.fromPixels(pixelsInput, 4)];
          }
        });
      });
    }
...
// node_modules/@tensorflow-models/pose-detection/dist/blazepose_mediapipe/constants.js
var require_constants2 = __commonJS({
  "node_modules/@tensorflow-models/pose-detection/dist/blazepose_mediapipe/constants.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
// node_modules/@tensorflow-models/pose-detection/dist/blazepose_mediapipe/detector_utils.js
var require_detector_utils = __commonJS({
  "node_modules/@tensorflow-models/pose-detection/dist/blazepose_mediapipe/detector_utils.js"(exports) {
    "use strict";
    ...
    function validateModelConfig(modelConfig) {
      ...
      if (config.enableSegmentation == null) {
        config.enableSegmentation = constants_1.DEFAULT_BLAZEPOSE_MODEL_CONFIG.enableSegmentation;
      }
      ...
      if (config.smoothSegmentation == null) {
        config.smoothSegmentation = constants_1.DEFAULT_BLAZEPOSE_MODEL_CONFIG.smoothSegmentation;
      }
...
// node_modules/@tensorflow-models/pose-detection/dist/blazepose_mediapipe/detector.js
var require_detector = __commonJS({
  "node_modules/@tensorflow-models/pose-detection/dist/blazepose_mediapipe/detector.js"(exports) {
    "use strict";
    var __awaiter = exports && exports.__awaiter || function(thisArg, _arguments, P, generator) {
      function adopt(value) {
        return value instanceof P ? value : new P(function(resolve) {
    ...
    var mask_util_1 = require_mask_util();
    var detector_utils_1 = require_detector_utils();
    var BlazePoseMediaPipeMask = (
      /** @class */
      function() {
        function BlazePoseMediaPipeMask2(mask) {
          this.mask = mask;
        }
        BlazePoseMediaPipeMask2.prototype.toCanvasImageSource = function() {
          return __awaiter(this, void 0, void 0, function() {
            return __generator(this, function(_a) {
              return [2, this.mask];
            });
        ...
        BlazePoseMediaPipeMask2.prototype.toImageData = function() {
          return __awaiter(this, void 0, void 0, function() {
            return __generator(this, function(_a) {
              return [2, (0, mask_util_1.toImageDataLossy)(this.mask)];
            });
          });
        };
        BlazePoseMediaPipeMask2.prototype.toTensor = function() {
          return __awaiter(this, void 0, void 0, function() {
            return __generator(this, function(_a) {
              return [2, (0, mask_util_1.toTensorLossy)(this.mask)];
            });
          });
        };
        BlazePoseMediaPipeMask2.prototype.getUnderlyingType = function() {
          return "canvasimagesource";
        };
        return BlazePoseMediaPipeMask2;
      }()
    );
    ...
    var BlazePoseMediaPipeDetector = (
      /** @class */
      function() {
        function BlazePoseMediaPipeDetector2(config) {
          var _this = this;
          this.width = 0;
          this.height = 0;
        ...
        BlazePoseMediaPipeDetector2.prototype.translateOutput = function(pose2, pose3D) {
          var _this = this;
          var output = {
            keypoints: pose2.map(function(landmark, i) {
              return {
          ...
          if (pose3D != null) {
            output.keypoints3D = pose3D.map(function(landmark, i) {
              return {
                x: landmark.x,
                y: landmark.y,
                z: landmark.z,
        ...
        BlazePoseMediaPipeDetector2.prototype.estimatePoses = function(image, estimationConfig, timestamp) {
          return __awaiter(this, void 0, void 0, function() {
            var _a, _b;
            return __generator(this, function(_c) {
              switch (_c.label) {
                ...
                case 3:
                  image = _a;
                  return [4, this.poseSolution.send({ image }, timestamp)];
                case 4:
                  _c.sent();
                  return [2, this.poses];
              }
        ...
        BlazePoseMediaPipeDetector2.prototype.dispose = function() {
          this.poseSolution.close();
        };
        BlazePoseMediaPipeDetector2.prototype.reset = function() {
          this.poseSolution.reset();
        };
        BlazePoseMediaPipeDetector2.prototype.initialize = function() {
          return this.poseSolution.initialize();
        };
        return BlazePoseMediaPipeDetector2;
      }()
    );
...
// node_modules/@tensorflow-models/pose-detection/dist/shared/calculators/image_utils.js
var require_image_utils = __commonJS({
  "node_modules/@tensorflow-models/pose-detection/dist/shared/calculators/image_utils.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    function validateSize(size, name) {
      tf.util.assert(size.width !== 0, function() {
        return "".concat(name, " width cannot be 0.");
      });
      tf.util.assert(size.height !== 0, function() {
        return "".concat(name, " height cannot be 0.");
      });
    }
  }
});
...
var require_detection_to_rect = __commonJS({
  "node_modules/@tensorflow-models/pose-detection/dist/shared/calculators/detection_to_rect.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.calculateDetectionsToRects = exports.computeRotation = void 0;
    var image_utils_1 = require_image_utils();
    ...
    function detectionToNormalizedRect(detection, conversionMode) {
      var locationData = detection.locationData;
      return conversionMode === "boundingbox" ? rectFromBox(locationData.relativeBoundingBox) : normRectFromKeypoints(locationData);
    }
    ...
    function calculateDetectionsToRects(detection, conversionMode, outputType, imageSize, rotationConfig) {
      var rect = outputType === "rect" ? detectionToRect(detection, conversionMode, imageSize) : detectionToNormalizedRect(detection, conversionMode);
      if (rotationConfig) {
...
var require_calculate_alignment_points_rects = __commonJS({
  "node_modules/@tensorflow-models/pose-detection/dist/shared/calculators/calculate_alignment_points_rects.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.calculateAlignmentPointsRects = void 0;
    var detection_to_rect_1 = require_detection_to_rect();
    function calculateAlignmentPointsRects(detection, imageSize, config) {
      ...
      var boxSize = Math.sqrt((xScale - xCenter) * (xScale - xCenter) + (yScale - yCenter) * (yScale - yCenter)) * 2;
...
// node_modules/@tensorflow-models/pose-detection/dist/shared/calculators/calculate_inverse_matrix.js
var require_calculate_inverse_matrix = __commonJS({
  "node_modules/@tensorflow-models/pose-detection/dist/shared/calculators/calculate_inverse_matrix.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    function calculateInverseMatrix(matrix) {
      ...
      var scale = matrix[0][0] * inverse[0][0] + matrix[1][0] * inverse[0][1] + matrix[2][0] * inverse[0][2] + matrix[3][0] * inverse[0][3];
...
// node_modules/@tensorflow-models/pose-detection/dist/shared/calculators/calculate_landmark_projection.js
var require_calculate_landmark_projection = __commonJS({
  "node_modules/@tensorflow-models/pose-detection/dist/shared/calculators/calculate_landmark_projection.js"(exports) {
    "use strict";
    var __assign = exports && exports.__assign || function() {
      __assign = Object.assign || function(t) {
        for (var s, i = 1, n = arguments.length; i < n; i++) {
    ...
    function calculateLandmarkProjection(landmarks, inputRect, config) {
      ...
      for (var _i = 0, landmarks_1 = landmarks; _i < landmarks_1.length; _i++) {
        ...
        var newZ = landmark.z * inputRect.width;
...
// node_modules/@tensorflow-models/pose-detection/dist/shared/calculators/calculate_score_copy.js
var require_calculate_score_copy = __commonJS({
  "node_modules/@tensorflow-models/pose-detection/dist/shared/calculators/calculate_score_copy.js"(exports) {
    "use strict";
    var __assign = exports && exports.__assign || function() {
      __assign = Object.assign || function(t) {
        for (var s, i = 1, n = arguments.length; i < n; i++) {
...
// node_modules/@tensorflow-models/pose-detection/dist/shared/calculators/calculate_world_landmark_projection.js
var require_calculate_world_landmark_projection = __commonJS({
  "node_modules/@tensorflow-models/pose-detection/dist/shared/calculators/calculate_world_landmark_projection.js"(exports) {
    "use strict";
    var __assign = exports && exports.__assign || function() {
      __assign = Object.assign || function(t) {
        for (var s, i = 1, n = arguments.length; i < n; i++) {
...
// node_modules/@tensorflow-models/pose-detection/dist/shared/calculators/constants.js
var require_constants3 = __commonJS({
  "node_modules/@tensorflow-models/pose-detection/dist/shared/calculators/constants.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    exports.MILLISECOND_TO_MICRO_SECONDS = 1e3;
  }
});

// node_modules/@tensorflow-models/pose-detection/dist/shared/calculators/get_rotated_sub_rect_to_rect_transformation_matrix.js
var require_get_rotated_sub_rect_to_rect_transformation_matrix = __commonJS({
  "node_modules/@tensorflow-models/pose-detection/dist/shared/calculators/get_rotated_sub_rect_to_rect_transformation_matrix.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.getRotatedSubRectToRectTransformMatrix = void 0;
    var calculate_inverse_matrix_1 = require_calculate_inverse_matrix();
...
// node_modules/@tensorflow-models/pose-detection/dist/shared/calculators/shift_image_value.js
var require_shift_image_value = __commonJS({
  "node_modules/@tensorflow-models/pose-detection/dist/shared/calculators/shift_image_value.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    function shiftImageValue(image, outputFloatRange) {
      var valueRange = (0, image_utils_1.transformValueRange)(
        0,
        255,
        outputFloatRange[0],
        outputFloatRange[1]
      ...
      return tf.tidy(function() {
        return tf.add(tf.mul(image, valueRange.scale), valueRange.offset);
      });
    }
...
// node_modules/@tensorflow-models/pose-detection/dist/shared/calculators/convert_image_to_tensor.js
var require_convert_image_to_tensor = __commonJS({
  "node_modules/@tensorflow-models/pose-detection/dist/shared/calculators/convert_image_to_tensor.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.convertImageToTensor = void 0;
    var tf = (init_dist(), __toCommonJS(dist_exports));
    var get_rotated_sub_rect_to_rect_transformation_matrix_1 = require_get_rotated_sub_rect_to_rect_transformation_matrix();
    var image_utils_1 = require_image_utils();
    var shift_image_value_1 = require_shift_image_value();
    function convertImageToTensor(image, config, normRect) {
      ...
      var imageTensor = tf.tidy(function() {
        ...
        var imageShifted = outputTensorFloatRange != null ? (0, shift_image_value_1.shiftImageValue)(imageTransformed, outputTensorFloatRange) : imageTransformed;
        return imageShifted;
      });
...
// node_modules/@tensorflow-models/pose-detection/dist/shared/calculators/create_ssd_anchors.js
var require_create_ssd_anchors = __commonJS({
  "node_modules/@tensorflow-models/pose-detection/dist/shared/calculators/create_ssd_anchors.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
        ...
        while (lastSameStrideLayer < config.strides.length && config.strides[lastSameStrideLayer] === config.strides[layerId]) {
          ...
          if (lastSameStrideLayer === 0 && config.reduceBoxesInLowestLayer) {
            ...
            if (config.interpolatedScaleAspectRatio > 0) {
              var scaleNext = lastSameStrideLayer === config.strides.length - 1 ? 1 : calculateScale(config.minScale, config.maxScale, lastSameStrideLayer + 1, config.strides.length);
        ...
        for (var y = 0; y < featureMapHeight; ++y) {
          for (var x = 0; x < featureMapWidth; ++x) {
            for (var anchorId = 0; anchorId < anchorHeight.length; ++anchorId) {
              ...
              var newAnchor = { xCenter, yCenter, width: 0, height: 0 };
...
// node_modules/@tensorflow-models/pose-detection/dist/shared/calculators/split_detection_result.js
var require_split_detection_result = __commonJS({
  "node_modules/@tensorflow-models/pose-detection/dist/shared/calculators/split_detection_result.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
// node_modules/@tensorflow-models/pose-detection/dist/shared/calculators/detector_result.js
var require_detector_result = __commonJS({
  "node_modules/@tensorflow-models/pose-detection/dist/shared/calculators/detector_result.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.detectorResult = void 0;
    var tf = (init_dist(), __toCommonJS(dist_exports));
    var split_detection_result_1 = require_split_detection_result();
...
// node_modules/@tensorflow-models/pose-detection/dist/shared/calculators/is_video.js
var require_is_video = __commonJS({
  "node_modules/@tensorflow-models/pose-detection/dist/shared/calculators/is_video.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
// node_modules/@tensorflow-models/pose-detection/dist/shared/calculators/landmarks_to_detection.js
var require_landmarks_to_detection = __commonJS({
  "node_modules/@tensorflow-models/pose-detection/dist/shared/calculators/landmarks_to_detection.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
// node_modules/@tensorflow-models/pose-detection/dist/shared/calculators/non_max_suppression.js
var require_non_max_suppression = __commonJS({
  "node_modules/@tensorflow-models/pose-detection/dist/shared/calculators/non_max_suppression.js"(exports) {
    "use strict";
    var __awaiter = exports && exports.__awaiter || function(thisArg, _arguments, P, generator) {
      function adopt(value) {
        return value instanceof P ? value : new P(function(resolve) {
    ...
    var tf = (init_dist(), __toCommonJS(dist_exports));
    function nonMaxSuppression(detections, maxDetections, iouThreshold, overlapType) {
      return __awaiter(this, void 0, void 0, function() {
        ...
        return __generator(this, function(_a) {
          switch (_a.label) {
            case 0:
              ...
              scoresTensor = tf.tensor1d(detections.map(function(d) {
                return d.score[0];
              }));
              return [4, tf.image.nonMaxSuppressionAsync(detectionsTensor, scoresTensor, maxDetections, iouThreshold)];
            case 1:
              selectedIdsTensor = _a.sent();
              return [4, selectedIdsTensor.array()];
            case 2:
              selectedIds = _a.sent();
              selectedDetections = detections.filter(function(_, i) {
                return selectedIds.indexOf(i) > -1;
              });
              tf.dispose([detectionsTensor, scoresTensor, selectedIdsTensor]);
              return [2, selectedDetections];
          }
        });
      });
    }
...
// node_modules/@tensorflow-models/pose-detection/dist/shared/calculators/normalized_keypoints_to_keypoints.js
var require_normalized_keypoints_to_keypoints = __commonJS({
  "node_modules/@tensorflow-models/pose-detection/dist/shared/calculators/normalized_keypoints_to_keypoints.js"(exports) {
    "use strict";
    var __assign = exports && exports.__assign || function() {
      __assign = Object.assign || function(t) {
        for (var s, i = 1, n = arguments.length; i < n; i++) {
...
// node_modules/@tensorflow-models/pose-detection/dist/shared/calculators/refine_landmarks_from_heatmap.js
var require_refine_landmarks_from_heatmap = __commonJS({
  "node_modules/@tensorflow-models/pose-detection/dist/shared/calculators/refine_landmarks_from_heatmap.js"(exports) {
    "use strict";
    var __assign = exports && exports.__assign || function() {
      __assign = Object.assign || function(t) {
        for (var s, i = 1, n = arguments.length; i < n; i++) {
          ...
          switch (_b.label) {
            case 0:
              ...
              if (landmarks.length !== hmChannels) {
                throw new Error("Expected heatmap to have same number of channels as the number of landmarks. But got landmarks length: " + "".concat(landmarks.length, ", heatmap length: ").concat(hmChannels));
              }
              outLandmarks = [];
              return [4, $heatmapTensor.buffer()];
            case 1:
              heatmapBuf = _b.sent();
...
// node_modules/@tensorflow-models/pose-detection/dist/shared/calculators/remove_detection_letterbox.js
var require_remove_detection_letterbox = __commonJS({
  "node_modules/@tensorflow-models/pose-detection/dist/shared/calculators/remove_detection_letterbox.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.removeDetectionLetterbox = void 0;
    function removeDetectionLetterbox(detections, letterboxPadding) {
      if (detections === void 0) {
        detections = [];
      }
...
// node_modules/@tensorflow-models/pose-detection/dist/shared/calculators/remove_landmark_letterbox.js
var require_remove_landmark_letterbox = __commonJS({
  "node_modules/@tensorflow-models/pose-detection/dist/shared/calculators/remove_landmark_letterbox.js"(exports) {
    "use strict";
    var __assign = exports && exports.__assign || function() {
      __assign = Object.assign || function(t) {
        for (var s, i = 1, n = arguments.length; i < n; i++) {
...
// node_modules/@tensorflow-models/pose-detection/dist/shared/calculators/segmentation_smoothing.js
var require_segmentation_smoothing = __commonJS({
  "node_modules/@tensorflow-models/pose-detection/dist/shared/calculators/segmentation_smoothing.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
var require_tensors_to_detections = __commonJS({
  "node_modules/@tensorflow-models/pose-detection/dist/shared/calculators/tensors_to_detections.js"(exports) {
    "use strict";
    var __awaiter = exports && exports.__awaiter || function(thisArg, _arguments, P, generator) {
      function adopt(value) {
        return value instanceof P ? value : new P(function(resolve) {
          ...
          switch (_a.label) {
            case 0:
              ...
              normalizedScore = tf.tidy(function() {
                var normalizedScore2 = rawScoreTensor;
                if (config.sigmoidScore) {
                  if (config.scoreClippingThresh != null) {
                    normalizedScore2 = tf.clipByValue(rawScoreTensor, -config.scoreClippingThresh, config.scoreClippingThresh);
                  }
                  normalizedScore2 = tf.sigmoid(normalizedScore2);
                  return normalizedScore2;
                }
                return normalizedScore2;
              });
              return [4, convertToDetections(boxes, normalizedScore, config)];
            case 1:
              outputDetections = _a.sent();
              tf.dispose([boxes, normalizedScore]);
              return [2, outputDetections];
          }
        });
      });
    }
      ...
      return __awaiter(this, void 0, void 0, function() {
        ...
        return __generator(this, function(_a) {
          switch (_a.label) {
            case 0:
              outputDetections = [];
              return [4, detectionBoxes.data()];
            case 1:
              detectionBoxesData = _a.sent();
              return [4, detectionScore.data()];
            case 2:
              ...
              for (i = 0; i < config.numBoxes; ++i) {
                ...
                detection = convertToDetection(detectionBoxesData[boxOffset + 0], detectionBoxesData[boxOffset + 1], detectionBoxesData[boxOffset + 2], detectionBoxesData[boxOffset + 3], detectionScoresData[i], config.flipVertically, i);
...
// node_modules/@tensorflow-models/pose-detection/dist/shared/calculators/sigmoid.js
var require_sigmoid = __commonJS({
  "node_modules/@tensorflow-models/pose-detection/dist/shared/calculators/sigmoid.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
// node_modules/@tensorflow-models/pose-detection/dist/shared/calculators/tensors_to_landmarks.js
var require_tensors_to_landmarks = __commonJS({
  "node_modules/@tensorflow-models/pose-detection/dist/shared/calculators/tensors_to_landmarks.js"(exports) {
    "use strict";
    var __awaiter = exports && exports.__awaiter || function(thisArg, _arguments, P, generator) {
      function adopt(value) {
        return value instanceof P ? value : new P(function(resolve) {
...
// node_modules/@tensorflow-models/pose-detection/dist/shared/calculators/tensors_to_segmentation.js
var require_tensors_to_segmentation = __commonJS({
  "node_modules/@tensorflow-models/pose-detection/dist/shared/calculators/tensors_to_segmentation.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    function tensorsToSegmentation(segmentationTensor, config, outputSize) {
      return tf.tidy(function() {
        ...
        if (tensorChannels === 1) {
          ...
          var outputMat = outputSize ? tf.image.resizeBilinear(smallMaskMat, [outputSize.height, outputSize.width]) : smallMaskMat;
...
// node_modules/@tensorflow-models/pose-detection/dist/shared/calculators/transform_rect.js
var require_transform_rect = __commonJS({
  "node_modules/@tensorflow-models/pose-detection/dist/shared/calculators/transform_rect.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    function transformNormalizedRect(rect, imageSize, config) {
      ...
      if (rotation === 0) {
        ...
        var xShift = (imageSize.width * width * config.shiftX * Math.cos(rotation) - imageSize.height * height * config.shiftY * Math.sin(rotation)) / imageSize.width;
        var yShift = (imageSize.width * width * config.shiftX * Math.sin(rotation) + imageSize.height * height * config.shiftY * Math.cos(rotation)) / imageSize.height;
...
// node_modules/@tensorflow-models/pose-detection/dist/shared/calculators/get_object_scale.js
var require_get_object_scale = __commonJS({
  "node_modules/@tensorflow-models/pose-detection/dist/shared/calculators/get_object_scale.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
// node_modules/@tensorflow-models/pose-detection/dist/shared/calculators/keypoints_to_normalized_keypoints.js
var require_keypoints_to_normalized_keypoints = __commonJS({
  "node_modules/@tensorflow-models/pose-detection/dist/shared/calculators/keypoints_to_normalized_keypoints.js"(exports) {
    "use strict";
    var __assign = exports && exports.__assign || function() {
      __assign = Object.assign || function(t) {
        for (var s, i = 1, n = arguments.length; i < n; i++) {
...
// node_modules/@tensorflow-models/pose-detection/dist/shared/filters/low_pass_filter.js
var require_low_pass_filter = __commonJS({
  "node_modules/@tensorflow-models/pose-detection/dist/shared/filters/low_pass_filter.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    var LowPassFilter = (
      /** @class */
      function() {
        function LowPassFilter2(alpha) {
          this.alpha = alpha;
          this.initialized = false;
        }
        LowPassFilter2.prototype.apply = function(value, threshold) {
          var result;
          if (this.initialized) {
            if (threshold == null) {
        ...
        LowPassFilter2.prototype.applyWithAlpha = function(value, alpha, threshold) {
          this.alpha = alpha;
          return this.apply(value, threshold);
        };
        LowPassFilter2.prototype.hasLastRawValue = function() {
          return this.initialized;
        };
        LowPassFilter2.prototype.lastRawValue = function() {
          return this.rawValue;
        };
        LowPassFilter2.prototype.reset = function() {
          this.initialized = false;
        };
...
// node_modules/@tensorflow-models/pose-detection/dist/shared/filters/one_euro_filter.js
var require_one_euro_filter = __commonJS({
  "node_modules/@tensorflow-models/pose-detection/dist/shared/filters/one_euro_filter.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.OneEuroFilter = void 0;
    var constants_1 = require_constants3();
    var low_pass_filter_1 = require_low_pass_filter();
    var OneEuroFilter = (
      /** @class */
      function() {
        function OneEuroFilter2(config) {
        ...
        OneEuroFilter2.prototype.apply = function(value, microSeconds, valueScale) {
          if (value == null) {
            return value;
          }
          ...
          if (this.lastTimestamp !== 0 && $microSeconds !== 0) {
            this.frequency = 1 / (($microSeconds - this.lastTimestamp) * constants_1.MICRO_SECONDS_TO_SECOND);
          }
          this.lastTimestamp = $microSeconds;
          var dValue = this.x.hasLastRawValue() ? (value - this.x.lastRawValue()) * valueScale * this.frequency : 0;
          ...
          var threshold = this.thresholdCutOff != null ? this.thresholdCutOff + this.thresholdBeta * Math.abs(edValue) : null;
          return this.x.applyWithAlpha(value, this.getAlpha(cutOff), threshold);
        };
        OneEuroFilter2.prototype.getAlpha = function(cutoff) {
          return 1 / (1 + this.frequency / (2 * Math.PI * cutoff));
        };
        return OneEuroFilter2;
      }()
    );
...
// node_modules/@tensorflow-models/pose-detection/dist/shared/filters/keypoints_one_euro_filter.js
var require_keypoints_one_euro_filter = __commonJS({
  "node_modules/@tensorflow-models/pose-detection/dist/shared/filters/keypoints_one_euro_filter.js"(exports) {
    "use strict";
    var __assign = exports && exports.__assign || function() {
      __assign = Object.assign || function(t) {
        for (var s, i = 1, n = arguments.length; i < n; i++) {
    ...
    var one_euro_filter_1 = require_one_euro_filter();
    var KeypointsOneEuroFilter = (
      /** @class */
      function() {
        function KeypointsOneEuroFilter2(config) {
          this.config = config;
        }
        KeypointsOneEuroFilter2.prototype.apply = function(keypoints, microSeconds, objectScale) {
          var _this = this;
          if (keypoints == null) {
            this.reset();
            return null;
          ...
          return keypoints.map(function(keypoint, i) {
            ...
            if (keypoint.z != null) {
              outKeypoint.z = _this.zFilters[i].apply(keypoint.z, microSeconds, valueScale);
            }
            return outKeypoint;
          });
        };
        KeypointsOneEuroFilter2.prototype.reset = function() {
          this.xFilters = null;
          this.yFilters = null;
          this.zFilters = null;
        };
        KeypointsOneEuroFilter2.prototype.initializeFiltersIfEmpty = function(keypoints) {
          var _this = this;
          if (this.xFilters == null || this.xFilters.length !== keypoints.length) {
            this.xFilters = keypoints.map(function(_) {
              return new one_euro_filter_1.OneEuroFilter(_this.config);
            });
            this.yFilters = keypoints.map(function(_) {
              return new one_euro_filter_1.OneEuroFilter(_this.config);
            });
            this.zFilters = keypoints.map(function(_) {
              return new one_euro_filter_1.OneEuroFilter(_this.config);
            });
          }
        };
        return KeypointsOneEuroFilter2;
      }()
    );
...
// node_modules/@tensorflow-models/pose-detection/dist/shared/filters/relative_velocity_filter.js
var require_relative_velocity_filter = __commonJS({
  "node_modules/@tensorflow-models/pose-detection/dist/shared/filters/relative_velocity_filter.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.RelativeVelocityFilter = void 0;
    var constants_1 = require_constants3();
    var low_pass_filter_1 = require_low_pass_filter();
    var RelativeVelocityFilter = (
      /** @class */
      function() {
        function RelativeVelocityFilter2(config) {
          this.config = config;
          this.window = [];
          this.lowPassFilter = new low_pass_filter_1.LowPassFilter(1);
          this.lastValue = 0;
          this.lastValueScale = 1;
          this.lastTimestamp = -1;
        }
        RelativeVelocityFilter2.prototype.apply = function(value, microSeconds, valueScale) {
          if (value == null) {
            return value;
          }
          var $microSeconds = Math.trunc(microSeconds);
        ...
        return RelativeVelocityFilter2;
      }()
    );
...
// node_modules/@tensorflow-models/pose-detection/dist/shared/filters/keypoints_velocity_filter.js
var require_keypoints_velocity_filter = __commonJS({
  "node_modules/@tensorflow-models/pose-detection/dist/shared/filters/keypoints_velocity_filter.js"(exports) {
    "use strict";
    var __assign = exports && exports.__assign || function() {
      __assign = Object.assign || function(t) {
        for (var s, i = 1, n = arguments.length; i < n; i++) {
    ...
    var relative_velocity_filter_1 = require_relative_velocity_filter();
    var KeypointsVelocityFilter = (
      /** @class */
      function() {
        function KeypointsVelocityFilter2(config) {
          this.config = config;
        }
        KeypointsVelocityFilter2.prototype.apply = function(keypoints, microSeconds, objectScale) {
          var _this = this;
          if (keypoints == null) {
            this.reset();
            return null;
        ...
        KeypointsVelocityFilter2.prototype.reset = function() {
          this.xFilters = null;
          this.yFilters = null;
          this.zFilters = null;
        };
        KeypointsVelocityFilter2.prototype.initializeFiltersIfEmpty = function(keypoints) {
          var _this = this;
          if (this.xFilters == null || this.xFilters.length !== keypoints.length) {
            this.xFilters = keypoints.map(function(_) {
              return new relative_velocity_filter_1.RelativeVelocityFilter(_this.config);
            });
            this.yFilters = keypoints.map(function(_) {
              return new relative_velocity_filter_1.RelativeVelocityFilter(_this.config);
            });
        ...
        return KeypointsVelocityFilter2;
      }()
    );
...
// node_modules/@tensorflow-models/pose-detection/dist/shared/filters/keypoints_smoothing.js
var require_keypoints_smoothing = __commonJS({
  "node_modules/@tensorflow-models/pose-detection/dist/shared/filters/keypoints_smoothing.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.KeypointsSmoothingFilter = void 0;
    var get_object_scale_1 = require_get_object_scale();
    var keypoints_to_normalized_keypoints_1 = require_keypoints_to_normalized_keypoints();
    var normalized_keypoints_to_keypoints_1 = require_normalized_keypoints_to_keypoints();
    var keypoints_one_euro_filter_1 = require_keypoints_one_euro_filter();
    var keypoints_velocity_filter_1 = require_keypoints_velocity_filter();
    var KeypointsSmoothingFilter = (
      /** @class */
      function() {
        function KeypointsSmoothingFilter2(config) {
          if (config.velocityFilter != null) {
            ...
            throw new Error("Either configure velocityFilter or oneEuroFilter, but got " + "".concat(config, "."));
          }
        }
        KeypointsSmoothingFilter2.prototype.apply = function(keypoints, timestamp, imageSize, normalized, objectScaleROI) {
          ...
          var scaledKeypoints = normalized ? (0, normalized_keypoints_to_keypoints_1.normalizedKeypointsToKeypoints)(keypoints, imageSize) : keypoints;
          var scaledKeypointsFiltered = this.keypointsFilter.apply(scaledKeypoints, timestamp, objectScale);
          return normalized ? (0, keypoints_to_normalized_keypoints_1.keypointsToNormalizedKeypoints)(scaledKeypointsFiltered, imageSize) : scaledKeypointsFiltered;
        };
        return KeypointsSmoothingFilter2;
      }()
    );
...
// node_modules/@tensorflow-models/pose-detection/dist/shared/filters/visibility_smoothing.js
var require_visibility_smoothing = __commonJS({
  "node_modules/@tensorflow-models/pose-detection/dist/shared/filters/visibility_smoothing.js"(exports) {
    "use strict";
    var __assign = exports && exports.__assign || function() {
      __assign = Object.assign || function(t) {
        for (var s, i = 1, n = arguments.length; i < n; i++) {
    ...
    var low_pass_filter_1 = require_low_pass_filter();
    var LowPassVisibilityFilter = (
      /** @class */
      function() {
        function LowPassVisibilityFilter2(config) {
          this.alpha = config.alpha;
        }
        LowPassVisibilityFilter2.prototype.apply = function(landmarks) {
          var _this = this;
          if (landmarks == null) {
          ...
          if (this.visibilityFilters == null || this.visibilityFilters.length !== landmarks.length) {
            this.visibilityFilters = landmarks.map(function(_) {
              return new low_pass_filter_1.LowPassFilter(_this.alpha);
            });
          }
          var outLandmarks = [];
          for (var i = 0; i < landmarks.length; ++i) {
        ...
        return LowPassVisibilityFilter2;
      }()
    );
...
var require_constants4 = __commonJS({
  "node_modules/@tensorflow-models/pose-detection/dist/blazepose_tfjs/constants.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    exports.BLAZEPOSE_WORLD_LANDMARKS_SMOOTHING_CONFIG_ACTUAL = {
      oneEuroFilter: {
        ...
        // As world landmarks are predicted in real world 3D coordintates
    ...
    exports.BLAZEPOSE_TENSORS_TO_SEGMENTATION_CONFIG = {
      activation: "none"
      // Sigmoid is not needed since it is already part of the model.
    };
...
// node_modules/@tensorflow-models/pose-detection/dist/blazepose_tfjs/detector_utils.js
var require_detector_utils2 = __commonJS({
  "node_modules/@tensorflow-models/pose-detection/dist/blazepose_tfjs/detector_utils.js"(exports) {
    "use strict";
    var __assign = exports && exports.__assign || function() {
      __assign = Object.assign || function(t) {
        for (var s, i = 1, n = arguments.length; i < n; i++) {
    ...
    function validateModelConfig(modelConfig) {
      var config = modelConfig == null ? __assign({}, constants_1.DEFAULT_BLAZEPOSE_MODEL_CONFIG) : __assign({}, modelConfig);
      if (config.enableSmoothing == null) {
        config.enableSmoothing = constants_1.DEFAULT_BLAZEPOSE_MODEL_CONFIG.enableSmoothing;
      }
      if (config.enableSegmentation == null) {
...
var require_detector2 = __commonJS({
  "node_modules/@tensorflow-models/pose-detection/dist/blazepose_tfjs/detector.js"(exports) {
    "use strict";
    var __assign = exports && exports.__assign || function() {
      __assign = Object.assign || function(t) {
        for (var s, i = 1, n = arguments.length; i < n; i++) {
    ...
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.load = void 0;
    var tfconv = (init_dist2(), __toCommonJS(dist_exports2));
    var tf = (init_dist(), __toCommonJS(dist_exports));
    var constants_1 = require_constants();
    var calculate_alignment_points_rects_1 = require_calculate_alignment_points_rects();
    var calculate_inverse_matrix_1 = require_calculate_inverse_matrix();
    var calculate_landmark_projection_1 = require_calculate_landmark_projection();
    var calculate_score_copy_1 = require_calculate_score_copy();
    var calculate_world_landmark_projection_1 = require_calculate_world_landmark_projection();
    var constants_2 = require_constants3();
    var convert_image_to_tensor_1 = require_convert_image_to_tensor();
    var create_ssd_anchors_1 = require_create_ssd_anchors();
    var detector_result_1 = require_detector_result();
    var image_utils_1 = require_image_utils();
    var is_video_1 = require_is_video();
    var landmarks_to_detection_1 = require_landmarks_to_detection();
    var mask_util_1 = require_mask_util();
    var non_max_suppression_1 = require_non_max_suppression();
    var normalized_keypoints_to_keypoints_1 = require_normalized_keypoints_to_keypoints();
    var refine_landmarks_from_heatmap_1 = require_refine_landmarks_from_heatmap();
    var remove_detection_letterbox_1 = require_remove_detection_letterbox();
    var remove_landmark_letterbox_1 = require_remove_landmark_letterbox();
    var segmentation_smoothing_1 = require_segmentation_smoothing();
    var tensors_to_detections_1 = require_tensors_to_detections();
    var tensors_to_landmarks_1 = require_tensors_to_landmarks();
    var tensors_to_segmentation_1 = require_tensors_to_segmentation();
    var transform_rect_1 = require_transform_rect();
    var keypoints_smoothing_1 = require_keypoints_smoothing();
    var visibility_smoothing_1 = require_visibility_smoothing();
    var constants = require_constants4();
    var detector_utils_1 = require_detector_utils2();
    var BlazePoseTfjsMask = (
      /** @class */
      function() {
        function BlazePoseTfjsMask2(mask) {
          this.mask = mask;
        }
        BlazePoseTfjsMask2.prototype.toCanvasImageSource = function() {
          return __awaiter(this, void 0, void 0, function() {
            return __generator(this, function(_a) {
              return [2, (0, mask_util_1.toHTMLCanvasElementLossy)(this.mask)];
            });
          });
        };
        BlazePoseTfjsMask2.prototype.toImageData = function() {
          return __awaiter(this, void 0, void 0, function() {
            return __generator(this, function(_a) {
              return [2, (0, mask_util_1.toImageDataLossy)(this.mask)];
            });
        ...
        BlazePoseTfjsMask2.prototype.toTensor = function() {
          return __awaiter(this, void 0, void 0, function() {
            return __generator(this, function(_a) {
              return [2, this.mask];
            });
        ...
        BlazePoseTfjsMask2.prototype.getUnderlyingType = function() {
          return "tensor";
        };
        return BlazePoseTfjsMask2;
      }()
    );
    function maskValueToLabel(maskValue) {
      (0, mask_util_1.assertMaskValue)(maskValue);
    ...
    var BlazePoseTfjsDetector = (
      /** @class */
      function() {
        function BlazePoseTfjsDetector2(detectorModel, landmarkModel, enableSmoothing, enableSegmentation, smoothSegmentation, modelType) {
          ...
          this.anchors = (0, create_ssd_anchors_1.createSsdAnchors)(constants.BLAZEPOSE_DETECTOR_ANCHOR_CONFIGURATION);
          var anchorW = tf.tensor1d(this.anchors.map(function(a) {
            return a.width;
          }));
          var anchorH = tf.tensor1d(this.anchors.map(function(a) {
            return a.height;
          }));
          var anchorX = tf.tensor1d(this.anchors.map(function(a) {
            return a.xCenter;
          }));
          var anchorY = tf.tensor1d(this.anchors.map(function(a) {
            return a.yCenter;
          }));
          this.anchorTensor = { x: anchorX, y: anchorY, w: anchorW, h: anchorH };
          this.prevFilteredSegmentationMask = this.enableSegmentation ? tf.tensor2d([], [0, 0]) : null;
        }
        BlazePoseTfjsDetector2.prototype.estimatePoses = function(image, estimationConfig, timestamp) {
          return __awaiter(this, void 0, void 0, function() {
              ...
              switch (_b.label) {
                case 0:
                  ...
                  if (timestamp != null) {
                    ...
                    this.timestamp = (0, is_video_1.isVideo)(image) ? image.currentTime * constants_2.SECOND_TO_MICRO_SECONDS : null;
                  }
                  imageSize = (0, image_utils_1.getImageSize)(image);
                  image3d = tf.tidy(function() {
                    return tf.cast((0, image_utils_1.toImageTensor)(image), "float32");
                  });
                  poseRect = this.regionOfInterest;
                  if (!(poseRect == null)) return [3, 2];
                  return [4, this.detectPose(image3d)];
                case 1:
                  detections = _b.sent();
                  ...
                  _b.label = 2;
                case 2:
                  return [4, this.poseLandmarksByRoi(poseRect, image3d)];
                case 3:
                  ...
                  filteredSegmentationMask = this.smoothSegmentation && unfilteredSegmentationMask != null ? this.poseSegmentationFiltering(unfilteredSegmentationMask) : unfilteredSegmentationMask;
                  keypoints = poseLandmarks != null ? (0, normalized_keypoints_to_keypoints_1.normalizedKeypointsToKeypoints)(poseLandmarks, imageSize) : null;
                  if (keypoints != null) {
                  ...
                  pose = { score: poseScore, keypoints, keypoints3D };
        ...
        BlazePoseTfjsDetector2.prototype.poseSegmentationFiltering = function(segmentationMask) {
        ...
        BlazePoseTfjsDetector2.prototype.dispose = function() {
        ...
        BlazePoseTfjsDetector2.prototype.reset = function() {
          this.regionOfInterest = null;
        ...
        BlazePoseTfjsDetector2.prototype.detectPose = function(image) {
          return __awaiter(this, void 0, void 0, function() {
            ...
            return __generator(this, function(_c) {
              switch (_c.label) {
                case 0:
                  ...
                  return [4, (0, tensors_to_detections_1.tensorsToDetections)([logits, boxes], this.anchorTensor, constants.BLAZEPOSE_TENSORS_TO_DETECTION_CONFIGURATION)];
                case 1:
                  detections = _c.sent();
                  if (detections.length === 0) {
                  ...
                  return [4, (0, non_max_suppression_1.nonMaxSuppression)(detections, this.maxPoses, constants.BLAZEPOSE_DETECTOR_NON_MAX_SUPPRESSION_CONFIGURATION.minSuppressionThreshold, constants.BLAZEPOSE_DETECTOR_NON_MAX_SUPPRESSION_CONFIGURATION.overlapType)];
                case 2:
                  ...
                  tf.dispose([imageValueShifted, detectionResult, logits, boxes]);
                  return [2, newDetections];
              }
            });
          });
        };
        BlazePoseTfjsDetector2.prototype.poseDetectionToRoi = function(detection, imageSize) {
        ...
        BlazePoseTfjsDetector2.prototype.poseLandmarksByRoi = function(roi, image) {
          return __awaiter(this, void 0, void 0, function() {
            ...
            return __generator(this, function(_b) {
              switch (_b.label) {
                case 0:
                  ...
                  return [4, this.tensorsToPoseLandmarksAndSegmentation(outputTensor)];
                case 1:
                  ...
                  return [4, this.poseLandmarksAndSegmentationInverseProjection(imageSize, roi, letterboxPadding, transformationMatrix, roiLandmarks, roiAuxiliaryLandmarks, roiWorldLandmarks, roiSegmentationMask)];
                case 2:
                  poseLandmarksAndSegmentationInverseProjectionResults = _b.sent();
                  tf.dispose(outputTensor);
                  tf.dispose(imageValueShifted);
                  return [2, __assign({ poseScore }, poseLandmarksAndSegmentationInverseProjectionResults)];
              }
            });
          });
        };
        BlazePoseTfjsDetector2.prototype.poseLandmarksAndSegmentationInverseProjection = function(imageSize, roi, letterboxPadding, transformationMatrix, roiLandmarks, roiAuxiliaryLandmarks, roiWorldLandmarks, roiSegmentationMask) {
          return __awaiter(this, void 0, void 0, function() {
            ...
            return __generator(this, function(_a) {
              ...
              if (this.enableSegmentation) {
                segmentationMask = tf.tidy(function() {
                  var _a2 = roiSegmentationMask.shape, inputHeight = _a2[0], inputWidth = _a2[1];
              ...
              return [2, { landmarks, auxiliaryLandmarks, worldLandmarks, segmentationMask }];
            });
          });
        };
        BlazePoseTfjsDetector2.prototype.tensorsToPoseLandmarksAndSegmentation = function(tensors) {
          return __awaiter(this, void 0, void 0, function() {
            ...
            return __generator(this, function(_a) {
              switch (_a.label) {
                case 0:
                  ...
                  return [4, poseFlagTensor.data()];
                case 1:
                  poseScore = _a.sent()[0];
                  if (poseScore < constants.BLAZEPOSE_POSE_PRESENCE_SCORE) {
                    return [2, null];
                  }
                  return [4, (0, tensors_to_landmarks_1.tensorsToLandmarks)(landmarkTensor, constants.BLAZEPOSE_TENSORS_TO_LANDMARKS_CONFIG)];
                case 2:
                  rawLandmarks = _a.sent();
                  return [4, (0, refine_landmarks_from_heatmap_1.refineLandmarksFromHeatmap)(rawLandmarks, heatmapTensor, constants.BLAZEPOSE_REFINE_LANDMARKS_FROM_HEATMAP_CONFIG)];
                case 3:
                  ...
                  return [4, (0, tensors_to_landmarks_1.tensorsToLandmarks)(worldLandmarkTensor, constants.BLAZEPOSE_TENSORS_TO_WORLD_LANDMARKS_CONFIG)];
                case 4:
                  ...
                  segmentationMask = this.enableSegmentation ? (0, tensors_to_segmentation_1.tensorsToSegmentation)(segmentationTensor, constants.BLAZEPOSE_TENSORS_TO_SEGMENTATION_CONFIG) : null;
                  return [2, {
                    landmarks,
                    auxiliaryLandmarks,
                    poseScore,
        ...
        BlazePoseTfjsDetector2.prototype.poseLandmarksToRoi = function(landmarks, imageSize) {
        ...
        BlazePoseTfjsDetector2.prototype.poseLandmarkFiltering = function(actualLandmarks, auxiliaryLandmarks, actualWorldLandmarks, imageSize) {
          ...
          if (this.timestamp == null || !this.enableSmoothing) {
            ...
            actualLandmarksFiltered = this.landmarksSmoothingFilterActual.apply(actualLandmarksFiltered, this.timestamp, imageSize, true, objectScaleROI);
            ...
            auxiliaryLandmarksFiltered = this.landmarksSmoothingFilterAuxiliary.apply(auxiliaryLandmarksFiltered, this.timestamp, imageSize, true, objectScaleROI);
            ...
            actualWorldLandmarksFiltered = this.worldLandmarksSmoothingFilterActual.apply(actualWorldLandmarks, this.timestamp);
          }
          return {
      ...
      return __awaiter(this, void 0, void 0, function() {
        ...
        return __generator(this, function(_b) {
          switch (_b.label) {
            case 0:
              config = (0, detector_utils_1.validateModelConfig)(modelConfig);
              detectorFromTFHub = typeof config.detectorModelUrl === "string" && config.detectorModelUrl.indexOf("https://tfhub.dev") > -1;
              landmarkFromTFHub = typeof config.landmarkModelUrl === "string" && config.landmarkModelUrl.indexOf("https://tfhub.dev") > -1;
            ...
            case 1:
              ...
              return [2, new BlazePoseTfjsDetector(detectorModel, landmarkModel, config.enableSmoothing, config.enableSegmentation, config.smoothSegmentation, config.modelType)];
          }
        });
      });
    }
...
// node_modules/@tensorflow-models/pose-detection/dist/calculators/tracker_utils.js
var require_tracker_utils = __commonJS({
  "node_modules/@tensorflow-models/pose-detection/dist/calculators/tracker_utils.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.validateTrackerConfig = void 0;
    function validateTrackerConfig(config) {
      if (config.maxTracks < 1) {
        throw new Error("Must specify 'maxTracks' to be at least 1, but " + "encountered ".concat(config.maxTracks));
      }
      if (config.maxAge <= 0) {
        throw new Error("Must specify 'maxAge' to be positive, but " + "encountered ".concat(config.maxAge));
      }
      if (config.keypointTrackerParams !== void 0) {
        if (config.keypointTrackerParams.keypointConfidenceThreshold < 0 || config.keypointTrackerParams.keypointConfidenceThreshold > 1) {
          throw new Error("Must specify 'keypointConfidenceThreshold' to be in the range [0, 1], but encountered " + "".concat(config.keypointTrackerParams.keypointConfidenceThreshold));
        }
        if (config.keypointTrackerParams.minNumberOfKeypoints < 1) {
          throw new Error("Must specify 'minNumberOfKeypoints' to be at least 1, but " + "encountered ".concat(config.keypointTrackerParams.minNumberOfKeypoints));
        }
        for (var _i = 0, _a = config.keypointTrackerParams.keypointFalloff; _i < _a.length; _i++) {
          var falloff = _a[_i];
          if (falloff <= 0) {
            throw new Error("Must specify each keypoint falloff parameterto be positive " + "but encountered ".concat(falloff));
          }
        }
      }
    }
...
// node_modules/@tensorflow-models/pose-detection/dist/calculators/tracker.js
var require_tracker = __commonJS({
  "node_modules/@tensorflow-models/pose-detection/dist/calculators/tracker.js"(exports) {
    "use strict";
    var __assign = exports && exports.__assign || function() {
      __assign = Object.assign || function(t) {
        for (var s, i = 1, n = arguments.length; i < n; i++) {
    ...
    var tracker_utils_1 = require_tracker_utils();
    var Tracker = (
      /** @class */
      function() {
        function Tracker2(config) {
        ...
        Tracker2.prototype.apply = function(poses, timestamp) {
        ...
        Tracker2.prototype.getTracks = function() {
          return this.tracks.slice();
        };
        Tracker2.prototype.getTrackIDs = function() {
          return new Set(this.tracks.map(function(track) {
            return track.id;
          }));
        };
        Tracker2.prototype.filterOldTracks = function(timestamp) {
          var _this = this;
          this.tracks = this.tracks.filter(function(track) {
            return timestamp - track.lastTimestamp <= _this.maxAge;
          });
        };
        Tracker2.prototype.assignTracks = function(poses, simMatrix, timestamp) {
        ...
        Tracker2.prototype.updateTracks = function(timestamp) {
          this.tracks.sort(function(ta, tb) {
            return tb.lastTimestamp - ta.lastTimestamp;
          });
          this.tracks = this.tracks.slice(0, this.maxTracks);
        };
        Tracker2.prototype.createTrack = function(pose, timestamp, trackID) {
          var track = {
            id: trackID || this.nextTrackID(),
            lastTimestamp: timestamp,
            keypoints: __spreadArray([], pose.keypoints, true).map(function(keypoint) {
              return __assign({}, keypoint);
            })
          };
          if (pose.box !== void 0) {
        ...
        Tracker2.prototype.nextTrackID = function() {
          var nextID = this.nextID;
          this.nextID += 1;
          return nextID;
        };
        Tracker2.prototype.remove = function() {
          var ids = [];
        ...
        Tracker2.prototype.reset = function() {
          this.tracks = [];
        };
        return Tracker2;
      }()
...
// node_modules/@tensorflow-models/pose-detection/dist/calculators/bounding_box_tracker.js
var require_bounding_box_tracker = __commonJS({
  "node_modules/@tensorflow-models/pose-detection/dist/calculators/bounding_box_tracker.js"(exports) {
    "use strict";
    ...
    var BoundingBoxTracker = (
      /** @class */
      function(_super) {
        __extends(BoundingBoxTracker2, _super);
        function BoundingBoxTracker2(config) {
          return _super.call(this, config) || this;
        }
        BoundingBoxTracker2.prototype.computeSimilarity = function(poses) {
          var _this = this;
        ...
        BoundingBoxTracker2.prototype.iou = function(pose, track) {
...
// node_modules/@tensorflow-models/pose-detection/dist/calculators/keypoint_tracker.js
var require_keypoint_tracker = __commonJS({
  "node_modules/@tensorflow-models/pose-detection/dist/calculators/keypoint_tracker.js"(exports) {
    "use strict";
    var __extends = exports && exports.__extends || /* @__PURE__ */ function() {
      var extendStatics = function(d, b) {
        extendStatics = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(d2, b2) {
    ...
    var KeypointTracker = (
      /** @class */
      function(_super) {
        __extends(KeypointTracker2, _super);
        function KeypointTracker2(config) {
          var _this = _super.call(this, config) || this;
          _this.keypointThreshold = config.keypointTrackerParams.keypointConfidenceThreshold;
        ...
        KeypointTracker2.prototype.computeSimilarity = function(poses) {
          if (poses.length === 0 || this.tracks.length === 0) {
            return [[]];
          }
          var simMatrix = [];
        ...
        KeypointTracker2.prototype.oks = function(pose, track) {
          ...
          for (var i = 0; i < pose.keypoints.length; ++i) {
            ...
            numValidKeypoints += 1;
            var dSquared = Math.pow(poseKpt.x - trackKpt.x, 2) + Math.pow(poseKpt.y - trackKpt.y, 2);
        ...
        KeypointTracker2.prototype.area = function(keypoints) {
          var _this = this;
          var validKeypoint = keypoints.filter(function(kpt) {
            return kpt.score > _this.keypointThreshold;
          });
          var minX = Math.min.apply(Math, __spreadArray([1], validKeypoint.map(function(kpt) {
            return kpt.x;
          }), false));
          var maxX = Math.max.apply(Math, __spreadArray([0], validKeypoint.map(function(kpt) {
            return kpt.x;
          }), false));
          var minY = Math.min.apply(Math, __spreadArray([1], validKeypoint.map(function(kpt) {
            return kpt.y;
          }), false));
          var maxY = Math.max.apply(Math, __spreadArray([0], validKeypoint.map(function(kpt) {
            return kpt.y;
          }), false));
          return (maxX - minX) * (maxY - minY);
        };
        return KeypointTracker2;
      }(tracker_1.Tracker)
    );
...
// node_modules/@tensorflow-models/pose-detection/dist/calculators/types.js
var require_types = __commonJS({
  "node_modules/@tensorflow-models/pose-detection/dist/calculators/types.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.TrackerType = void 0;
    var TrackerType;
    (function(TrackerType2) {
...
// node_modules/@tensorflow-models/pose-detection/dist/types.js
var require_types2 = __commonJS({
  "node_modules/@tensorflow-models/pose-detection/dist/types.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.SupportedModels = void 0;
    var SupportedModels;
    (function(SupportedModels2) {
...
// node_modules/@tensorflow-models/pose-detection/dist/util.js
var require_util = __commonJS({
  "node_modules/@tensorflow-models/pose-detection/dist/util.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
// node_modules/@tensorflow-models/pose-detection/dist/movenet/constants.js
var require_constants5 = __commonJS({
  "node_modules/@tensorflow-models/pose-detection/dist/movenet/constants.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    exports.NUM_KEYPOINT_VALUES = 3;
    exports.MULTIPOSE_BOX_SIZE = 5;
...
// node_modules/@tensorflow-models/pose-detection/dist/movenet/crop_utils.js
var require_crop_utils = __commonJS({
  "node_modules/@tensorflow-models/pose-detection/dist/movenet/crop_utils.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    function torsoVisible(keypoints, keypointIndexByName) {
      return (keypoints[keypointIndexByName["left_hip"]].score > constants_2.MIN_CROP_KEYPOINT_SCORE || keypoints[keypointIndexByName["right_hip"]].score > constants_2.MIN_CROP_KEYPOINT_SCORE) && (keypoints[keypointIndexByName["left_shoulder"]].score > constants_2.MIN_CROP_KEYPOINT_SCORE || keypoints[keypointIndexByName["right_shoulder"]].score > constants_2.MIN_CROP_KEYPOINT_SCORE);
    }
    ...
    function determineTorsoAndBodyRange(keypoints, keypointIndexByName, targetKeypoints, centerY, centerX) {
      ...
      var maxTorsoYrange = 0;
      var maxTorsoXrange = 0;
...
// node_modules/@tensorflow-models/pose-detection/dist/movenet/detector_utils.js
var require_detector_utils3 = __commonJS({
  "node_modules/@tensorflow-models/pose-detection/dist/movenet/detector_utils.js"(exports) {
    "use strict";
    var __assign = exports && exports.__assign || function() {
      __assign = Object.assign || function(t) {
        for (var s, i = 1, n = arguments.length; i < n; i++) {
    ...
    function validateModelConfig(modelConfig) {
      ...
      if (config.modelType == null) {
        ...
        throw new Error("Invalid architecture ".concat(config.modelType, ". ") + "Should be one of ".concat(constants_1.VALID_MODELS));
      }
      if (config.enableSmoothing == null) {
      ...
      if (config.modelType === constants_1.MULTIPOSE_LIGHTNING && config.enableTracking == null) {
        config.enableTracking = true;
      }
      if (config.modelType === constants_1.MULTIPOSE_LIGHTNING && config.enableTracking === true) {
...
// node_modules/@tensorflow-models/pose-detection/dist/movenet/detector.js
var require_detector3 = __commonJS({
  "node_modules/@tensorflow-models/pose-detection/dist/movenet/detector.js"(exports) {
    "use strict";
    var __awaiter = exports && exports.__awaiter || function(thisArg, _arguments, P, generator) {
      function adopt(value) {
        return value instanceof P ? value : new P(function(resolve) {
    ...
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.load = void 0;
    var tfc = (init_dist2(), __toCommonJS(dist_exports2));
    var tf = (init_dist(), __toCommonJS(dist_exports));
    var bounding_box_tracker_1 = require_bounding_box_tracker();
    var keypoint_tracker_1 = require_keypoint_tracker();
    var types_1 = require_types();
    var constants_1 = require_constants();
    var constants_2 = require_constants3();
    var image_utils_1 = require_image_utils();
    ...
    var crop_utils_1 = require_crop_utils();
    var detector_utils_1 = require_detector_utils3();
    var MoveNetDetector = (
      /** @class */
      function() {
        function MoveNetDetector2(moveNetModel, config) {
          ...
          if (config.modelType === constants_3.SINGLEPOSE_LIGHTNING) {
            ...
            this.modelInputResolution.height = constants_3.MOVENET_SINGLEPOSE_LIGHTNING_RESOLUTION;
        ...
        MoveNetDetector2.prototype.runSinglePersonPoseModel = function(inputImage) {
          return __awaiter(this, void 0, void 0, function() {
            ...
            return __generator(this, function(_a) {
              switch (_a.label) {
                case 0:
                  ...
                  if (outputTensor.shape.length !== 4 || outputTensor.shape[0] !== 1 || outputTensor.shape[1] !== 1 || outputTensor.shape[2] !== constants_3.NUM_KEYPOINTS || outputTensor.shape[3] !== constants_3.NUM_KEYPOINT_VALUES) {
                    outputTensor.dispose();
                    throw new Error("Unexpected output shape from model: [".concat(outputTensor.shape, "]"));
                  }
                  if (!(tf.getBackend() !== "webgpu")) return [3, 1];
                  inferenceResult = outputTensor.dataSync();
                  return [3, 3];
                case 1:
                  return [4, outputTensor.data()];
                case 2:
                  inferenceResult = _a.sent();
                  _a.label = 3;
                case 3:
                  outputTensor.dispose();
                  pose = { keypoints: [], score: 0 };
                  numValidKeypoints = 0;
        ...
        MoveNetDetector2.prototype.runMultiPersonPoseModel = function(inputImage) {
          return __awaiter(this, void 0, void 0, function() {
            ...
            return __generator(this, function(_a) {
              switch (_a.label) {
                case 0:
                  outputTensor = this.moveNetModel.execute(inputImage);
                  if (outputTensor.shape.length !== 3 || outputTensor.shape[0] !== 1 || outputTensor.shape[2] !== constants_3.MULTIPOSE_INSTANCE_SIZE) {
                    outputTensor.dispose();
                    throw new Error("Unexpected output shape from model: [".concat(outputTensor.shape, "]"));
                  }
                  if (!(tf.getBackend() !== "webgpu")) return [3, 1];
        ...
        MoveNetDetector2.prototype.estimatePoses = function(image, estimationConfig, timestamp) {
          if (estimationConfig === void 0) {
            estimationConfig = constants_3.MOVENET_ESTIMATION_CONFIG;
          }
          return __awaiter(this, void 0, void 0, function() {
            ...
            return __generator(this, function(_a) {
              switch (_a.label) {
                case 0:
                  ...
                  poses = [];
                  if (!!this.multiPoseModel) return [3, 2];
                  return [4, this.estimateSinglePose(imageTensor4D, imageSize, timestamp)];
                case 1:
                  poses = _a.sent();
                  return [3, 4];
                case 2:
                  return [4, this.estimateMultiplePoses(imageTensor4D, imageSize, timestamp)];
                case 3:
                  poses = _a.sent();
                  _a.label = 4;
                case 4:
                  for (poseIdx = 0; poseIdx < poses.length; ++poseIdx) {
                    for (keypointIdx = 0; keypointIdx < poses[poseIdx].keypoints.length; ++keypointIdx) {
                      poses[poseIdx].keypoints[keypointIdx].name = constants_1.COCO_KEYPOINTS[keypointIdx];
        ...
        MoveNetDetector2.prototype.estimateSinglePose = function(imageTensor4D, imageSize, timestamp) {
          return __awaiter(this, void 0, void 0, function() {
                ...
                case 0:
                  ...
                  croppedImage = tf.tidy(function() {
                    var cropRegionTensor = tf.tensor2d([[
                      _this.cropRegion.yMin,
                      _this.cropRegion.xMin,
                      _this.cropRegion.yMax,
                  ...
                  return [4, this.runSinglePersonPoseModel(croppedImage)];
                case 1:
                  pose = _a.sent();
        ...
        MoveNetDetector2.prototype.estimateMultiplePoses = function(imageTensor4D, imageSize, timestamp) {
          return __awaiter(this, void 0, void 0, function() {
              ...
              switch (_a.label) {
                case 0:
                  ...
                  if (imageSize.width > imageSize.height) {
                    ...
                    resizedImage = tf.image.resizeBilinear(imageTensor4D, [resizedHeight, resizedWidth]);
                  ...
                  paddedImage.dispose();
                  return [4, this.runMultiPersonPoseModel(paddedImageInt32)];
                case 1:
                  poses = _a.sent();
                  paddedImageInt32.dispose();
                  poses = poses.filter(function(pose) {
                    return pose.score >= _this.minPoseScore;
                  });
                  ...
                  if (this.enableTracking) {
                    ...
                    if (this.enableSmoothing) {
                      for (i = 0; i < poses.length; ++i) {
                        ...
                        poses[i].keypoints = this.keypointFilterMap.get(poses[i].id).apply(
                          poses[i].keypoints,
                          timestamp,
                          1
                          /* objectScale */
        ...
        MoveNetDetector2.prototype.filterCropRegion = function(newCropRegion) {
          if (!newCropRegion) {
        ...
        MoveNetDetector2.prototype.dispose = function() {
          this.moveNetModel.dispose();
        };
        MoveNetDetector2.prototype.reset = function() {
          this.cropRegion = null;
          this.resetFilters();
        };
        MoveNetDetector2.prototype.resetFilters = function() {
        ...
        return MoveNetDetector2;
      }()
    );
    function load(modelConfig) {
      if (modelConfig === void 0) {
        modelConfig = constants_3.MOVENET_CONFIG;
      }
      return __awaiter(this, void 0, void 0, function() {
        ...
        return __generator(this, function(_a) {
          switch (_a.label) {
            case 0:
              config = (0, detector_utils_1.validateModelConfig)(modelConfig);
              fromTFHub = true;
              if (!!!config.modelUrl) return [3, 2];
              fromTFHub = typeof config.modelUrl === "string" && config.modelUrl.indexOf("https://tfhub.dev") > -1;
              return [4, tfc.loadGraphModel(config.modelUrl, { fromTFHub })];
            case 1:
              model = _a.sent();
              return [3, 4];
            case 2:
              ...
              return [4, tfc.loadGraphModel(modelUrl, { fromTFHub })];
            case 3:
              model = _a.sent();
              _a.label = 4;
            case 4:
              ...
              return [2, new MoveNetDetector(model, config)];
          }
        });
      });
    }
...
// node_modules/@tensorflow-models/pose-detection/dist/posenet/constants.js
var require_constants6 = __commonJS({
  "node_modules/@tensorflow-models/pose-detection/dist/posenet/constants.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    exports.RESNET_MEAN = [-123.15, -115.9, -103.06];
...
// node_modules/@tensorflow-models/pose-detection/dist/posenet/calculators/max_heap.js
var require_max_heap = __commonJS({
  "node_modules/@tensorflow-models/pose-detection/dist/posenet/calculators/max_heap.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
// node_modules/@tensorflow-models/pose-detection/dist/posenet/calculators/build_part_with_score_queue.js
var require_build_part_with_score_queue = __commonJS({
  "node_modules/@tensorflow-models/pose-detection/dist/posenet/calculators/build_part_with_score_queue.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
var require_decode_multiple_poses_util = __commonJS({
  "node_modules/@tensorflow-models/pose-detection/dist/posenet/calculators/decode_multiple_poses_util.js"(exports) {
    "use strict";
    var __awaiter = exports && exports.__awaiter || function(thisArg, _arguments, P, generator) {
      function adopt(value) {
        return value instanceof P ? value : new P(function(resolve) {
    ...
    function withinNmsRadiusOfCorrespondingPoint(poses, squaredNmsRadius, _a, keypointId) {
      ...
      return poses.some(function(_a2) {
        ...
        return squaredDistance(y, x, keypoints[keypointId].y, keypoints[keypointId].x) <= squaredNmsRadius;
      });
    }
...
var require_decode_multiple_poses = __commonJS({
  "node_modules/@tensorflow-models/pose-detection/dist/posenet/calculators/decode_multiple_poses.js"(exports) {
    "use strict";
    var __awaiter = exports && exports.__awaiter || function(thisArg, _arguments, P, generator) {
      function adopt(value) {
        return value instanceof P ? value : new P(function(resolve) {
    ...
    var decode_multiple_poses_util_1 = require_decode_multiple_poses_util();
    function decodeMultiplePoses(heatmapScores, offsets, displacementFwd, displacementBwd, outputStride, maxPoseDetections, scoreThreshold, nmsRadius) {
      ...
      return __awaiter(this, void 0, void 0, function() {
        ...
        return __generator(this, function(_b) {
          switch (_b.label) {
            case 0:
              return [4, (0, decode_multiple_poses_util_1.toTensorBuffers3D)([heatmapScores, offsets, displacementFwd, displacementBwd])];
            case 1:
...
// node_modules/@tensorflow-models/pose-detection/dist/posenet/ops/webgpu_util.js
var require_webgpu_util = __commonJS({
  "node_modules/@tensorflow-models/pose-detection/dist/posenet/ops/webgpu_util.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
// node_modules/@tensorflow-models/pose-detection/dist/posenet/ops/get_points_confidence_webgpu.js
var require_get_points_confidence_webgpu = __commonJS({
  "node_modules/@tensorflow-models/pose-detection/dist/posenet/ops/get_points_confidence_webgpu.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.getPointsConfidenceWebGPU = void 0;
    var tfwebgpu = (init_dist3(), __toCommonJS(dist_exports3));
    var tf = (init_dist(), __toCommonJS(dist_exports));
    var webgpu_util_1 = require_webgpu_util();
    var GetpointsConfidenceProgram = (
      /** @class */
      function() {
        function GetpointsConfidenceProgram2(bShape) {
        ...
        GetpointsConfidenceProgram2.prototype.getUserCode = function() {
          return "\n        ".concat((0, webgpu_util_1.getMainHeaderString)("index"), " {\n          if (index < uniforms.size) {\n            let y = B[index * 2];\n            let x = B[index * 2 + 1];\n            let outIndex = y * uniforms.aShape.x * uniforms.aShape.z + x * uniforms.aShape.z + index;\n            result[index] = A[outIndex];\n          }\n        }\n        ");
        };
        return GetpointsConfidenceProgram2;
      }()
    );
...
// node_modules/@tensorflow-models/pose-detection/dist/posenet/ops/get_points_confidence.js
var require_get_points_confidence = __commonJS({
  "node_modules/@tensorflow-models/pose-detection/dist/posenet/ops/get_points_confidence.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.getPointsConfidenceGPU = void 0;
    var tfwebgpu = (init_dist3(), __toCommonJS(dist_exports3));
    var tf = (init_dist(), __toCommonJS(dist_exports));
    var get_points_confidence_webgpu_1 = require_get_points_confidence_webgpu();
...
var require_get_offset_vectors_webgpu = __commonJS({
  "node_modules/@tensorflow-models/pose-detection/dist/posenet/ops/get_offset_vectors_webgpu.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    var tf = (init_dist(), __toCommonJS(dist_exports));
    var webgpu_util_1 = require_webgpu_util();
    var GetOffsetVectorsProgram = (
      /** @class */
      function() {
        function GetOffsetVectorsProgram2(outputShape) {
          this.variableNames = ["A", "B"];
          this.size = true;
          this.supportedLastDimension = 2;
          if (outputShape.length !== 2 || outputShape[1] !== this.supportedLastDimension) {
          ...
          this.dispatchLayout = tfwebgpu.webgpu_util.flatDispatchLayout(computeDispatchInfo);
        ...
        GetOffsetVectorsProgram2.prototype.getUserCode = function() {
          return "\n    fn getOffsetPoint(y: i32, x: i32, index: i32) -> vec2<i32> {\n      let outIndexY = y * uniforms.bShape.x * uniforms.bShape.y + x * uniforms.bShape.y + index;\n      let outIndexX = outIndexY + uniforms.bShape.z;\n      let outY = i32(B[outIndexY]);\n      let outX = i32(B[outIndexX]);\n      return vec2<i32>(outY, outX);\n    }\n\n    ".concat((0, webgpu_util_1.getMainHeaderString)("index"), " {\n      if (index < uniforms.size) {\n        let indexY = index * ").concat(this.supportedLastDimension, ";\n        let indexX = indexY + 1;\n        let heatmapY = A[indexY];\n        let heatmapX = A[indexX];\n        let out = getOffsetPoint(i32(heatmapY), i32(heatmapX), index);\n        result[indexY] = f32(out[0]);\n        result[indexX] = f32(out[1]);\n      }\n    }\n    ");
        };
        return GetOffsetVectorsProgram2;
      }()
    );
...
var require_get_offset_vectors = __commonJS({
  "node_modules/@tensorflow-models/pose-detection/dist/posenet/ops/get_offset_vectors.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.getOffsetVectorsGPU = void 0;
    var tfwebgpu = (init_dist3(), __toCommonJS(dist_exports3));
    var tf = (init_dist(), __toCommonJS(dist_exports));
    var get_offset_vectors_webgpu_1 = require_get_offset_vectors_webgpu();
...
var require_decode_single_pose_util = __commonJS({
  "node_modules/@tensorflow-models/pose-detection/dist/posenet/calculators/decode_single_pose_util.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    var tf = (init_dist(), __toCommonJS(dist_exports));
    var constants_1 = require_constants();
    var get_offset_vectors_1 = require_get_offset_vectors();
    function mod(a, b) {
      return tf.tidy(function() {
...
var require_decode_single_pose = __commonJS({
  "node_modules/@tensorflow-models/pose-detection/dist/posenet/calculators/decode_single_pose.js"(exports) {
    "use strict";
    var __awaiter = exports && exports.__awaiter || function(thisArg, _arguments, P, generator) {
      function adopt(value) {
        return value instanceof P ? value : new P(function(resolve) {
    ...
    var constants_1 = require_constants();
    var get_points_confidence_1 = require_get_points_confidence();
    var decode_single_pose_util_1 = require_decode_single_pose_util();
        ...
        return __generator(this, function(_a) {
          switch (_a.label) {
            ...
            case 2:
              ...
              return [2, { keypoints, score: totalScore / keypoints.length }];
          }
        });
      });
    }
    ...
    function decodeSinglePoseGPU(heatmapScores, offsets, outputStride) {
      return __awaiter(this, void 0, void 0, function() {
        ...
        return __generator(this, function(_a) {
          ...
          return [2, [offsetPoints, keypointConfidence]];
        });
      });
    }
...
// node_modules/@tensorflow-models/pose-detection/dist/posenet/calculators/flip_poses.js
var require_flip_poses = __commonJS({
  "node_modules/@tensorflow-models/pose-detection/dist/posenet/calculators/flip_poses.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
// node_modules/@tensorflow-models/pose-detection/dist/posenet/calculators/scale_poses.js
var require_scale_poses = __commonJS({
  "node_modules/@tensorflow-models/pose-detection/dist/posenet/calculators/scale_poses.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
// node_modules/@tensorflow-models/pose-detection/dist/posenet/detector_utils.js
var require_detector_utils4 = __commonJS({
  "node_modules/@tensorflow-models/pose-detection/dist/posenet/detector_utils.js"(exports) {
    "use strict";
    var __assign = exports && exports.__assign || function() {
      __assign = Object.assign || function(t) {
        for (var s, i = 1, n = arguments.length; i < n; i++) {
    ...
    function validateModelConfig(modelConfig) {
      ...
      if (constants_1.VALID_ARCHITECTURE.indexOf(config.architecture) < 0) {
        throw new Error("Invalid architecture ".concat(config.architecture, ". ") + "Should be one of ".concat(constants_1.VALID_ARCHITECTURE));
      }
      ...
      if (constants_1.VALID_STRIDE[config.architecture].indexOf(config.outputStride) < 0) {
        throw new Error("Invalid outputStride ".concat(config.outputStride, ". ") + "Should be one of ".concat(constants_1.VALID_STRIDE[config.architecture], " ") + "for architecture ".concat(config.architecture, "."));
      }
      if (config.multiplier == null) {
        config.multiplier = 1;
      }
      if (constants_1.VALID_MULTIPLIER[config.architecture].indexOf(config.multiplier) < 0) {
        throw new Error("Invalid multiplier ".concat(config.multiplier, ". ") + "Should be one of ".concat(constants_1.VALID_MULTIPLIER[config.architecture], " ") + "for architecture ".concat(config.architecture, "."));
      }
      if (config.quantBytes == null) {
        config.quantBytes = 4;
      }
      if (constants_1.VALID_QUANT_BYTES.indexOf(config.quantBytes) < 0) {
        throw new Error("Invalid quantBytes ".concat(config.quantBytes, ". ") + "Should be one of ".concat(constants_1.VALID_QUANT_BYTES, " ") + "for architecture ".concat(config.architecture, "."));
      }
    ...
    function assertValidOutputStride(outputStride) {
      tf.util.assert(constants_1.VALID_OUTPUT_STRIDES.indexOf(outputStride) >= 0, function() {
        return "outputStride of ".concat(outputStride, " is invalid. ") + "It must be either 8 or 16.";
      });
    }
    ...
    function assertValidResolution(resolution, outputStride) {
      tf.util.assert(isValidInputResolution(resolution.height, outputStride), function() {
        return "height of ".concat(resolution.height, " is invalid for output stride ") + "".concat(outputStride, ".");
      });
      tf.util.assert(isValidInputResolution(resolution.width, outputStride), function() {
        return "width of ".concat(resolution.width, " is invalid for output stride ") + "".concat(outputStride, ".");
      });
    }
    ...
    function validateEstimationConfig(estimationConfig) {
      ...
      if (config.maxPoses > 1) {
        ...
        if (config.scoreThreshold < 0 || config.scoreThreshold > 1) {
          throw new Error("Invalid scoreThreshold ".concat(config.scoreThreshold, ". ") + "Should be in range [0.0, 1.0]");
        }
...
// node_modules/@tensorflow-models/pose-detection/dist/posenet/load_utils.js
var require_load_utils = __commonJS({
  "node_modules/@tensorflow-models/pose-detection/dist/posenet/load_utils.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
// node_modules/@tensorflow-models/pose-detection/dist/posenet/detector.js
var require_detector4 = __commonJS({
  "node_modules/@tensorflow-models/pose-detection/dist/posenet/detector.js"(exports) {
    "use strict";
    var __awaiter = exports && exports.__awaiter || function(thisArg, _arguments, P, generator) {
      function adopt(value) {
        return value instanceof P ? value : new P(function(resolve) {
    ...
    var decode_single_pose_1 = require_decode_single_pose();
    var flip_poses_1 = require_flip_poses();
    var scale_poses_1 = require_scale_poses();
    var constants_1 = require_constants6();
    var detector_utils_1 = require_detector_utils4();
    var load_utils_1 = require_load_utils();
    var PosenetDetector = (
      /** @class */
      function() {
        function PosenetDetector2(posenetModel, config) {
        ...
        PosenetDetector2.prototype.estimatePoses = function(image, estimationConfig) {
          if (estimationConfig === void 0) {
            estimationConfig = constants_1.SINGLE_PERSON_ESTIMATION_CONFIG;
          }
          return __awaiter(this, void 0, void 0, function() {
            return __generator(this, function(_a) {
              return [2, this.estimatePosesGPU(image, estimationConfig, false)];
            });
          });
        };
        PosenetDetector2.prototype.estimatePosesGPU = function(image, estimationConfig, useGpuRenderer) {
          if (estimationConfig === void 0) {
            estimationConfig = constants_1.SINGLE_PERSON_ESTIMATION_CONFIG;
          }
          if (useGpuRenderer === void 0) {
            ...
            return __generator(this, function(_c) {
              switch (_c.label) {
                case 0:
                  ...
                  imageValueShifted = this.architecture === "ResNet50" ? tf.add(imageTensor, constants_1.RESNET_MEAN) : (0, shift_image_value_1.shiftImageValue)(imageTensor, [-1, 1]);
                  ...
                  if (!(this.maxPoses === 1)) return [3, 5];
                  if (!useGpuRenderer) return [3, 2];
                  return [4, (0, decode_single_pose_1.decodeSinglePoseGPU)(heatmapScores, offsets, this.outputStride)];
                case 1:
                  _b = _c.sent(), pose = _b[0], score = _b[1];
                  poses = [pose, score];
                  return [3, 4];
                case 2:
                  return [4, (0, decode_single_pose_1.decodeSinglePose)(heatmapScores, offsets, this.outputStride)];
                case 3:
                  pose = _c.sent();
                  poses = [pose];
                  _c.label = 4;
                ...
                case 5:
                  ...
                  return [4, (0, decode_multiple_poses_1.decodeMultiplePoses)(heatmapScores, offsets, displacementFwd, displacementBwd, this.outputStride, this.maxPoses, config.scoreThreshold, config.nmsRadius)];
                case 6:
                  poses = _c.sent();
                  _c.label = 7;
                case 7:
                  ...
                  return [2, useGpuRenderer ? [poses, canvasInfo] : scaledPoses];
              }
            });
          });
        };
        PosenetDetector2.prototype.getCanvasInfo = function(imageSize, inputResolution, padding) {
          var height = imageSize.height, width = imageSize.width;
          var scaleY = height / (inputResolution.height * (1 - padding.top - padding.bottom));
          var scaleX = width / (inputResolution.width * (1 - padding.left - padding.right));
          var offsetY = -padding.top * inputResolution.height;
        ...
        PosenetDetector2.prototype.dispose = function() {
          this.posenetModel.dispose();
        };
        PosenetDetector2.prototype.reset = function() {
        };
        return PosenetDetector2;
      }()
    );
    function load(modelConfig) {
      if (modelConfig === void 0) {
        modelConfig = constants_1.MOBILENET_V1_CONFIG;
      }
      return __awaiter(this, void 0, void 0, function() {
        ...
        return __generator(this, function(_a) {
          switch (_a.label) {
            case 0:
              config = (0, detector_utils_1.validateModelConfig)(modelConfig);
              if (!(config.architecture === "ResNet50")) return [3, 2];
              defaultUrl_1 = (0, load_utils_1.resNet50Checkpoint)(config.outputStride, config.quantBytes);
              return [4, tfconv.loadGraphModel(config.modelUrl || defaultUrl_1)];
            case 1:
              model_1 = _a.sent();
              return [2, new PosenetDetector(model_1, config)];
            case 2:
              defaultUrl = (0, load_utils_1.mobileNetCheckpoint)(config.outputStride, config.multiplier, config.quantBytes);
              return [4, tfconv.loadGraphModel(config.modelUrl || defaultUrl)];
            case 3:
              model = _a.sent();
              return [2, new PosenetDetector(model, config)];
          }
        });
      });
    }
...
// node_modules/@tensorflow-models/pose-detection/dist/create_detector.js
var require_create_detector = __commonJS({
  "node_modules/@tensorflow-models/pose-detection/dist/create_detector.js"(exports) {
    "use strict";
    var __awaiter = exports && exports.__awaiter || function(thisArg, _arguments, P, generator) {
      function adopt(value) {
        return value instanceof P ? value : new P(function(resolve) {
    ...
    var detector_2 = require_detector2();
    var detector_3 = require_detector3();
    var detector_4 = require_detector4();
    var types_1 = require_types2();
    function createDetector(model, modelConfig) {
      return __awaiter(this, void 0, void 0, function() {
        ...
        return __generator(this, function(_a) {
          switch (model) {
            case types_1.SupportedModels.PoseNet:
              return [2, (0, detector_4.load)(modelConfig)];
            case types_1.SupportedModels.BlazePose:
              config = modelConfig;
              runtime = void 0;
              if (config != null) {
                if (config.runtime === "tfjs") {
                  return [2, (0, detector_2.load)(modelConfig)];
                }
                if (config.runtime === "mediapipe") {
                  return [2, (0, detector_1.load)(modelConfig)];
                }
                runtime = config.runtime;
              }
              throw new Error("Expect modelConfig.runtime to be either 'tfjs' " + "or 'mediapipe', but got ".concat(runtime));
            case types_1.SupportedModels.MoveNet:
              return [2, (0, detector_3.load)(modelConfig)];
            default:
...
var require_dist = __commonJS({
  "node_modules/@tensorflow-models/pose-detection/dist/index.js"(exports) {
    ...
    var create_detector_1 = require_create_detector();
    Object.defineProperty(exports, "createDetector", { enumerable: true, get: function() {
      return create_detector_1.createDetector;
    } });
    __exportStar(require_types2(), exports);
    var types_1 = require_types();
    Object.defineProperty(exports, "TrackerType", { enumerable: true, get: function() {
      return types_1.TrackerType;
    } });
...
@tensorflow-models/pose-detection/dist/constants.js:
  (**
   * @license
...
@tensorflow-models/pose-detection/dist/shared/calculators/mask_util.js:
  (**
   * @license
   * Copyright 2021 Google LLC. All Rights Reserved.
   * Licensed under the Apache License, Version 2.0 (the "License");
...
@tensorflow-models/pose-detection/dist/blazepose_mediapipe/detector_utils.js:
  (**
   * @license
   * Copyright 2021 Google LLC. All Rights Reserved.
   * Licensed under the Apache License, Version 2.0 (the "License");
...
@tensorflow-models/pose-detection/dist/blazepose_mediapipe/detector.js:
  (**
   * @license
   * Copyright 2021 Google LLC. All Rights Reserved.
   * Licensed under the Apache License, Version 2.0 (the "License");
...
@tensorflow-models/pose-detection/dist/shared/calculators/image_utils.js:
  (**
   * @license
   * Copyright 2021 Google LLC. All Rights Reserved.
   * Licensed under the Apache License, Version 2.0 (the "License");
...
@tensorflow-models/pose-detection/dist/shared/calculators/detection_to_rect.js:
  (**
   * @license
   * Copyright 2021 Google LLC. All Rights Reserved.
   * Licensed under the Apache License, Version 2.0 (the "License");
...
@tensorflow-models/pose-detection/dist/shared/calculators/calculate_alignment_points_rects.js:
  (**
   * @license
   * Copyright 2021 Google LLC. All Rights Reserved.
   * Licensed under the Apache License, Version 2.0 (the "License");
...
@tensorflow-models/pose-detection/dist/shared/calculators/calculate_inverse_matrix.js:
  (**
   * @license
   * Copyright 2021 Google LLC. All Rights Reserved.
   * Licensed under the Apache License, Version 2.0 (the "License");
...
@tensorflow-models/pose-detection/dist/shared/calculators/calculate_landmark_projection.js:
  (**
   * @license
   * Copyright 2021 Google LLC. All Rights Reserved.
   * Licensed under the Apache License, Version 2.0 (the "License");
...
@tensorflow-models/pose-detection/dist/shared/calculators/calculate_score_copy.js:
  (**
   * @license
   * Copyright 2021 Google LLC. All Rights Reserved.
   * Licensed under the Apache License, Version 2.0 (the "License");
...
@tensorflow-models/pose-detection/dist/shared/calculators/calculate_world_landmark_projection.js:
  (**
   * @license
   * Copyright 2021 Google LLC. All Rights Reserved.
   * Licensed under the Apache License, Version 2.0 (the "License");
...
@tensorflow-models/pose-detection/dist/shared/calculators/constants.js:
  (**
   * @license
   * Copyright 2021 Google LLC. All Rights Reserved.
   * Licensed under the Apache License, Version 2.0 (the "License");
...
@tensorflow-models/pose-detection/dist/shared/calculators/get_rotated_sub_rect_to_rect_transformation_matrix.js:
  (**
   * @license
   * Copyright 2021 Google LLC. All Rights Reserved.
   * Licensed under the Apache License, Version 2.0 (the "License");
...
@tensorflow-models/pose-detection/dist/shared/calculators/shift_image_value.js:
  (**
   * @license
   * Copyright 2021 Google LLC. All Rights Reserved.
   * Licensed under the Apache License, Version 2.0 (the "License");
...
@tensorflow-models/pose-detection/dist/shared/calculators/convert_image_to_tensor.js:
  (**
   * @license
   * Copyright 2021 Google LLC. All Rights Reserved.
   * Licensed under the Apache License, Version 2.0 (the "License");
...
@tensorflow-models/pose-detection/dist/shared/calculators/create_ssd_anchors.js:
  (**
   * @license
   * Copyright 2021 Google LLC. All Rights Reserved.
   * Licensed under the Apache License, Version 2.0 (the "License");
...
@tensorflow-models/pose-detection/dist/shared/calculators/split_detection_result.js:
  (**
   * @license
   * Copyright 2021 Google LLC. All Rights Reserved.
   * Licensed under the Apache License, Version 2.0 (the "License");
...
@tensorflow-models/pose-detection/dist/shared/calculators/detector_result.js:
  (**
   * @license
   * Copyright 2021 Google LLC. All Rights Reserved.
   * Licensed under the Apache License, Version 2.0 (the "License");
...
@tensorflow-models/pose-detection/dist/shared/calculators/is_video.js:
  (**
   * @license
   * Copyright 2021 Google LLC. All Rights Reserved.
   * Licensed under the Apache License, Version 2.0 (the "License");
...
@tensorflow-models/pose-detection/dist/shared/calculators/landmarks_to_detection.js:
  (**
   * @license
   * Copyright 2021 Google LLC. All Rights Reserved.
   * Licensed under the Apache License, Version 2.0 (the "License");
...
@tensorflow-models/pose-detection/dist/shared/calculators/non_max_suppression.js:
  (**
   * @license
   * Copyright 2021 Google LLC. All Rights Reserved.
   * Licensed under the Apache License, Version 2.0 (the "License");
...
@tensorflow-models/pose-detection/dist/shared/calculators/refine_landmarks_from_heatmap.js:
  (**
   * @license
   * Copyright 2021 Google LLC. All Rights Reserved.
   * Licensed under the Apache License, Version 2.0 (the "License");
...
@tensorflow-models/pose-detection/dist/shared/calculators/remove_detection_letterbox.js:
  (**
   * @license
   * Copyright 2021 Google LLC. All Rights Reserved.
   * Licensed under the Apache License, Version 2.0 (the "License");
...
@tensorflow-models/pose-detection/dist/shared/calculators/remove_landmark_letterbox.js:
  (**
   * @license
   * Copyright 2021 Google LLC. All Rights Reserved.
   * Licensed under the Apache License, Version 2.0 (the "License");
...
@tensorflow-models/pose-detection/dist/shared/calculators/tensors_to_detections.js:
  (**
   * @license
   * Copyright 2021 Google LLC. All Rights Reserved.
   * Licensed under the Apache License, Version 2.0 (the "License");
...
@tensorflow-models/pose-detection/dist/shared/calculators/sigmoid.js:
  (**
   * @license
   * Copyright 2021 Google LLC. All Rights Reserved.
   * Licensed under the Apache License, Version 2.0 (the "License");
...
@tensorflow-models/pose-detection/dist/shared/calculators/tensors_to_segmentation.js:
  (**
   * @license
   * Copyright 2021 Google LLC. All Rights Reserved.
   * Licensed under the Apache License, Version 2.0 (the "License");
...
@tensorflow-models/pose-detection/dist/shared/calculators/transform_rect.js:
  (**
   * @license
   * Copyright 2021 Google LLC. All Rights Reserved.
   * Licensed under the Apache License, Version 2.0 (the "License");
...
@tensorflow-models/pose-detection/dist/shared/filters/low_pass_filter.js:
  (**
   * @license
   * Copyright 2021 Google LLC. All Rights Reserved.
   * Licensed under the Apache License, Version 2.0 (the "License");
...
@tensorflow-models/pose-detection/dist/shared/filters/one_euro_filter.js:
  (**
   * @license
   * Copyright 2021 Google LLC. All Rights Reserved.
   * Licensed under the Apache License, Version 2.0 (the "License");
...
@tensorflow-models/pose-detection/dist/shared/filters/keypoints_one_euro_filter.js:
  (**
   * @license
   * Copyright 2021 Google LLC. All Rights Reserved.
   * Licensed under the Apache License, Version 2.0 (the "License");
...
@tensorflow-models/pose-detection/dist/shared/filters/relative_velocity_filter.js:
  (**
   * @license
   * Copyright 2021 Google LLC. All Rights Reserved.
   * Licensed under the Apache License, Version 2.0 (the "License");
...
@tensorflow-models/pose-detection/dist/shared/filters/keypoints_smoothing.js:
  (**
   * @license
   * Copyright 2021 Google LLC. All Rights Reserved.
   * Licensed under the Apache License, Version 2.0 (the "License");
...
@tensorflow-models/pose-detection/dist/shared/filters/visibility_smoothing.js:
  (**
   * @license
   * Copyright 2021 Google LLC. All Rights Reserved.
   * Licensed under the Apache License, Version 2.0 (the "License");
...
@tensorflow-models/pose-detection/dist/blazepose_tfjs/constants.js:
  (**
   * @license
   * Copyright 2021 Google LLC. All Rights Reserved.
   * Licensed under the Apache License, Version 2.0 (the "License");
...
@tensorflow-models/pose-detection/dist/blazepose_tfjs/detector_utils.js:
  (**
   * @license
   * Copyright 2021 Google LLC. All Rights Reserved.
   * Licensed under the Apache License, Version 2.0 (the "License");
...
@tensorflow-models/pose-detection/dist/blazepose_tfjs/detector.js:
  (**
   * @license
   * Copyright 2021 Google LLC. All Rights Reserved.
   * Licensed under the Apache License, Version 2.0 (the "License");
...
@tensorflow-models/pose-detection/dist/calculators/tracker_utils.js:
  (**
   * @license
   * Copyright 2021 Google LLC. All Rights Reserved.
   * Licensed under the Apache License, Version 2.0 (the "License");
...
@tensorflow-models/pose-detection/dist/calculators/tracker.js:
  (**
   * @license
   * Copyright 2021 Google LLC. All Rights Reserved.
   * Licensed under the Apache License, Version 2.0 (the "License");
...
@tensorflow-models/pose-detection/dist/calculators/bounding_box_tracker.js:
  (**
   * @license
   * Copyright 2021 Google LLC. All Rights Reserved.
   * Licensed under the Apache License, Version 2.0 (the "License");
...
@tensorflow-models/pose-detection/dist/calculators/keypoint_tracker.js:
  (**
   * @license
   * Copyright 2021 Google LLC. All Rights Reserved.
   * Licensed under the Apache License, Version 2.0 (the "License");
...
@tensorflow-models/pose-detection/dist/calculators/types.js:
  (**
   * @license
   * Copyright 2021 Google LLC. All Rights Reserved.
   * Licensed under the Apache License, Version 2.0 (the "License");
...
@tensorflow-models/pose-detection/dist/util.js:
  (**
   * @license
   * Copyright 2021 Google LLC. All Rights Reserved.
   * Licensed under the Apache License, Version 2.0 (the "License");
...
@tensorflow-models/pose-detection/dist/movenet/constants.js:
  (**
   * @license
   * Copyright 2021 Google LLC. All Rights Reserved.
   * Licensed under the Apache License, Version 2.0 (the "License");
...
@tensorflow-models/pose-detection/dist/movenet/crop_utils.js:
  (**
   * @license
   * Copyright 2021 Google LLC. All Rights Reserved.
   * Licensed under the Apache License, Version 2.0 (the "License");
...
@tensorflow-models/pose-detection/dist/movenet/detector_utils.js:
  (**
   * @license
   * Copyright 2021 Google LLC. All Rights Reserved.
   * Licensed under the Apache License, Version 2.0 (the "License");
...
@tensorflow-models/pose-detection/dist/posenet/constants.js:
  (**
   * @license
   * Copyright 2021 Google LLC. All Rights Reserved.
   * Licensed under the Apache License, Version 2.0 (the "License");
...
@tensorflow-models/pose-detection/dist/posenet/calculators/max_heap.js:
  (**
   * @license
   * Copyright 2021 Google LLC. All Rights Reserved.
   * Licensed under the Apache License, Version 2.0 (the "License");
...
@tensorflow-models/pose-detection/dist/posenet/calculators/decode_multiple_poses.js:
  (**
   * @license
   * Copyright 2021 Google LLC. All Rights Reserved.
   * Licensed under the Apache License, Version 2.0 (the "License");
...
@tensorflow-models/pose-detection/dist/posenet/ops/webgpu_util.js:
  (**
   * @license
...
@tensorflow-models/pose-detection/dist/posenet/ops/get_points_confidence_webgpu.js:
  (**
   * @license
   * Copyright 2023 Google LLC.
   * Licensed under the Apache License, Version 2.0 (the "License");
...
@tensorflow-models/pose-detection/dist/posenet/ops/get_points_confidence.js:
  (**
   * @license
   * Copyright 2023 Google LLC.
   * Licensed under the Apache License, Version 2.0 (the "License");
...
@tensorflow-models/pose-detection/dist/posenet/ops/get_offset_vectors_webgpu.js:
  (**
   * @license
   * Copyright 2023 Google LLC.
   * Licensed under the Apache License, Version 2.0 (the "License");
...
@tensorflow-models/pose-detection/dist/posenet/ops/get_offset_vectors.js:
  (**
   * @license
   * Copyright 2023 Google LLC.
   * Licensed under the Apache License, Version 2.0 (the "License");
...
@tensorflow-models/pose-detection/dist/posenet/calculators/decode_single_pose_util.js:
  (**
   * @license
...
@tensorflow-models/pose-detection/dist/posenet/calculators/decode_single_pose.js:
  (**
   * @license
   * Copyright 2019 Google LLC. All Rights Reserved.
   * Licensed under the Apache License, Version 2.0 (the "License");
...
@tensorflow-models/pose-detection/dist/posenet/calculators/flip_poses.js:
  (**
   * @license
   * Copyright 2019 Google LLC. All Rights Reserved.
   * Licensed under the Apache License, Version 2.0 (the "License");
...
@tensorflow-models/pose-detection/dist/posenet/calculators/scale_poses.js:
  (**
   * @license
   * Copyright 2019 Google LLC. All Rights Reserved.
   * Licensed under the Apache License, Version 2.0 (the "License");
...
@tensorflow-models/pose-detection/dist/posenet/detector_utils.js:
  (**
   * @license
   * Copyright 2021 Google LLC. All Rights Reserved.
   * Licensed under the Apache License, Version 2.0 (the "License");
...
@tensorflow-models/pose-detection/dist/posenet/load_utils.js:
  (**
   * @license
   * Copyright 2021 Google LLC. All Rights Reserved.
   * Licensed under the Apache License, Version 2.0 (the "License");
...
@tensorflow-models/pose-detection/dist/posenet/detector.js:
  (**
   * @license
   * Copyright 2021 Google LLC. All Rights Reserved.
   * Licensed under the Apache License, Version 2.0 (the "License");
...
@tensorflow-models/pose-detection/dist/create_detector.js:
  (**
   * @license
   * Copyright 2021 Google LLC. All Rights Reserved.
   * Licensed under the Apache License, Version 2.0 (the "License");
   ...
   *)
*/
//# sourceMappingURL=@tensorflow-models_pose-detection_dist_index__js.js.map
